...
public class TicketItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:ticket")
	public static final Item block = null;

	public TicketItem(UltimateFnafModModElements instance) {
		super(instance, 91);
	}
