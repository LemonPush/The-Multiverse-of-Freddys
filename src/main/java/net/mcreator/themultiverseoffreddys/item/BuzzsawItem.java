...
import net.mcreator.themultiverseoffreddys.entity.renderer.BuzzsawRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

import java.util.Random;

@UltimateFnafModModElements.ModElement.Tag
public class BuzzsawItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:buzzsaw")
