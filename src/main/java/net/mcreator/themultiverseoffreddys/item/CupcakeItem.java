...
public class CupcakeItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:cupcake")
	public static final Item block = null;

	public CupcakeItem(UltimateFnafModModElements instance) {
		super(instance, 73);
	}
