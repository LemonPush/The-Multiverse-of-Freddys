...
public class SyringeItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:syringe")
	public static final Item block = null;

	public SyringeItem(UltimateFnafModModElements instance) {
		super(instance, 40);
	}
