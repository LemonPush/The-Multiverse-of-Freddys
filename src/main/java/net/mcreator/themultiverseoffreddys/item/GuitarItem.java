...
public class GuitarItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:guitar")
	public static final Item block = null;

	public GuitarItem(UltimateFnafModModElements instance) {
		super(instance, 64);
	}
