...
public class FazbarItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:fazbar")
	public static final Item block = null;

	public FazbarItem(UltimateFnafModModElements instance) {
		super(instance, 47);
	}
