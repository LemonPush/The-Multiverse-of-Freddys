...
public class BatteryItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:battery")
	public static final Item block = null;

	public BatteryItem(UltimateFnafModModElements instance) {
		super(instance, 10);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used for taming the SB characters"));
		}
	}
}
