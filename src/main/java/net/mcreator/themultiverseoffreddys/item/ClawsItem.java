...
public class ClawsItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:claws")
	public static final Item block = null;

	public ClawsItem(UltimateFnafModModElements instance) {
		super(instance, 95);
	}
