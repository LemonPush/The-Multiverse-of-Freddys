...
import net.mcreator.themultiverseoffreddys.entity.renderer.AgonyShootRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

import java.util.Random;

@UltimateFnafModModElements.ModElement.Tag
public class AgonyShootItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:agony_shoot")
