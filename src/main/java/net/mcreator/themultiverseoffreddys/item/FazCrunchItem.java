...
public class FazCrunchItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:faz_crunch")
	public static final Item block = null;

	public FazCrunchItem(UltimateFnafModModElements instance) {
		super(instance, 105);
	}
