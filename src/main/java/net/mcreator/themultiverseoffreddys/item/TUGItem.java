...
import net.mcreator.themultiverseoffreddys.gui.PageMainOverworldGuiWindow;
import net.mcreator.themultiverseoffreddys.gui.PageMainOverworldGui;
...
public class TUGItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:tug")
	public static final Item block = null;

	public TUGItem(UltimateFnafModModElements instance) {
		super(instance, 82);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PageMainOverworldGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("The Ultimate Guide");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PageMainOverworldGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
