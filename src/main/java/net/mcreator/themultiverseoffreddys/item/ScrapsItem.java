...
public class ScrapsItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:scraps")
	public static final Item block = null;

	public ScrapsItem(UltimateFnafModModElements instance) {
		super(instance, 108);
	}
