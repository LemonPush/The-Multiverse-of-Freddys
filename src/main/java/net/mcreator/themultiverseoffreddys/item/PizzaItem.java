...
public class PizzaItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:pizza")
	public static final Item block = null;

	public PizzaItem(UltimateFnafModModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used for taming the FNaF 1 characters"));
		}
	}
}
