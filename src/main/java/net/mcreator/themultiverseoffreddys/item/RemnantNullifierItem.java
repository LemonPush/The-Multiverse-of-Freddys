...
import net.mcreator.themultiverseoffreddys.procedures.RemnantNullifierRangedItemUsedProcedure;
import net.mcreator.themultiverseoffreddys.procedures.RemnantNullifierProjectileHitsLivingEntityProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.FlipSideTabItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.RemnantNullifierRenderer;
...
public class RemnantNullifierItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:remnant_nullifier")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(FlipSideTabItemGroup.tab).maxDamage(2031));
			setRegistryName("remnant_nullifier");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Can steal Life Energy out of anything"));
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					RemnantNullifierRangedItemUsedProcedure.executeProcedure(
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AgonyShootItem.block);
		}
		...
		public void onEntityHit(EntityRayTraceResult entityRayTraceResult) {
			...
			RemnantNullifierProjectileHitsLivingEntityProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
