...
import net.mcreator.themultiverseoffreddys.entity.renderer.LiloghostShootRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

import java.util.Random;

@UltimateFnafModModElements.ModElement.Tag
public class LiloghostShootItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:liloghost_shoot")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("liloghost_shoot");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AgonyItem.block);
		}
