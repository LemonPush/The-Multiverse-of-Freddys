...
public class ThesilvereyesItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:thesilvereyes")
	public static final Item block = null;

	public ThesilvereyesItem(UltimateFnafModModElements instance) {
		super(instance, 104);
	}
