...
public class PossessedBallItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:possessed_ball")
	public static final Item block = null;

	public PossessedBallItem(UltimateFnafModModElements instance) {
		super(instance, 107);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("possessed_ball");
		}
