...
public class AgonysuitItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:agonysuit_helmet")
	public static final Item helmet = null;
	@ObjectHolder("ultimate_fnaf_mod:agonysuit_chestplate")
	public static final Item body = null;
	@ObjectHolder("ultimate_fnaf_mod:agonysuit_leggings")
	public static final Item legs = null;
	@ObjectHolder("ultimate_fnaf_mod:agonysuit_boots")
		...
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(FlipSideTabItemGroup.tab).isImmuneToFire()) {
					...
					public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
						...
						armorModel.bipedHead = new ModelAnomalysuit().Head;
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "ultimate_fnaf_mod:textures/entities/anomalysuit.png";
					}
				}.setRegistryName("agonysuit_helmet"));
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(FlipSideTabItemGroup.tab).isImmuneToFire()) {
					...
					public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
						BipedModel armorModel = new BipedModel(1);
						armorModel.bipedBody = new ModelAnomalysuit().Body;
						armorModel.bipedLeftArm = new ModelAnomalysuit().LeftArm;
						armorModel.bipedRightArm = new ModelAnomalysuit().RightArm;
						armorModel.isSneak = living.isSneaking();
						armorModel.isSitting = defaultModel.isSitting;
						armorModel.isChild = living.isChild();
						return armorModel;
				...
				}.setRegistryName("agonysuit_chestplate"));
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(FlipSideTabItemGroup.tab).isImmuneToFire()) {
					...
					public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
						BipedModel armorModel = new BipedModel(1);
						armorModel.bipedLeftLeg = new ModelAnomalysuit().LeftLeg;
						armorModel.bipedRightLeg = new ModelAnomalysuit().RightLeg;
						armorModel.isSneak = living.isSneaking();
						armorModel.isSitting = defaultModel.isSitting;
						armorModel.isChild = living.isChild();
						return armorModel;
				...
				}.setRegistryName("agonysuit_leggings"));
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.FEET, new Item.Properties().group(FlipSideTabItemGroup.tab).isImmuneToFire()) {
					...
					public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
						BipedModel armorModel = new BipedModel(1);
						armorModel.bipedLeftLeg = new ModelAnomalysuit().LeftBoot;
						armorModel.bipedRightLeg = new ModelAnomalysuit().RightBoot;
						armorModel.isSneak = living.isSneaking();
						armorModel.isSitting = defaultModel.isSitting;
						armorModel.isChild = living.isChild();
						return armorModel;
				...
				}.setRegistryName("agonysuit_boots"));
	}
