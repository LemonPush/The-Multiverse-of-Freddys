...
public class BallItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:ball")
	public static final Item block = null;

	public BallItem(UltimateFnafModModElements instance) {
		super(instance, 106);
	}
