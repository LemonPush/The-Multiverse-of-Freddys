...
import net.mcreator.themultiverseoffreddys.entity.renderer.WallBreakRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

import java.util.Random;

@UltimateFnafModModElements.ModElement.Tag
public class WallBreakItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:wall_break")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(WallBreakItem.block);
		}
