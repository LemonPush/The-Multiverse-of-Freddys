...
import net.mcreator.themultiverseoffreddys.gui.BiggerBagGuiWindow;
import net.mcreator.themultiverseoffreddys.gui.BiggerBagGui;
...
public class FazBagItem extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:faz_bag")
	public static final Item block = null;

	public FazBagItem(UltimateFnafModModElements instance) {
		super(instance, 21);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BiggerBagGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(FNaFExtrasItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("faz_bag");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used for carrying items"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Faz-Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BiggerBagGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
