...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlakeRenderer;
...
public class BlakeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(PopgoesTabItemGroup.tab))
				.setRegistryName("blake_spawn_egg"));
	}
