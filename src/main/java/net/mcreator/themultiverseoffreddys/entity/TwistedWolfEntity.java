...
import net.mcreator.themultiverseoffreddys.entity.renderer.TwistedWolfRenderer;
...
public class TwistedWolfEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -10066330, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("twisted_wolf_spawn_egg"));
	}
