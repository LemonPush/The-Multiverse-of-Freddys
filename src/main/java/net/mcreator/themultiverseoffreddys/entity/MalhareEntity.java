...
import net.mcreator.themultiverseoffreddys.procedures.MalhareEntityDiesProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.F1ItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.MalhareRenderer;
...
public class MalhareEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13382656, -13395712, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("malhare_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, TameableEntity.class, false, false));
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:deadeyes")),
					0.15f, 1);
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:deathglitchtrap8"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			MalhareEntityDiesProcedure.executeProcedure(Stream
