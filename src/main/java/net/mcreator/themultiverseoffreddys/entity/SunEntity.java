...
import net.mcreator.themultiverseoffreddys.entity.renderer.SunRenderer;
...
public class SunEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -154, -6750208, new Item.Properties().group(FNaF9TabItemGroup.tab)).setRegistryName("sun_spawn_egg"));
	}
