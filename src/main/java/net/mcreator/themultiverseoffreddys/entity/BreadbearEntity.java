...
import net.mcreator.themultiverseoffreddys.entity.renderer.BreadbearRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class BreadbearEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -10079488, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("breadbear_spawn_egg"));
	}
