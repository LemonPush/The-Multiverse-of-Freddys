...
import net.mcreator.themultiverseoffreddys.entity.renderer.FuntimeChicaRenderer;
...
public class FuntimeChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3407821, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("funtime_chica_spawn_egg"));
	}
