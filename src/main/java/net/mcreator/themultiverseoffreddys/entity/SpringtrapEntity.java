...
import net.mcreator.themultiverseoffreddys.entity.renderer.SpringtrapRenderer;
...
public class SpringtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13349343, -12431582, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("springtrap_spawn_egg"));
	}
