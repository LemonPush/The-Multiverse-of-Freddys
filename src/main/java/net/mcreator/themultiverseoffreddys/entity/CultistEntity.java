...
import net.mcreator.themultiverseoffreddys.entity.renderer.CultistRenderer;
...
public class CultistEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -3355444, -1, new Item.Properties().group(F1ItemGroup.tab)).setRegistryName("cultist_spawn_egg"));
	}
