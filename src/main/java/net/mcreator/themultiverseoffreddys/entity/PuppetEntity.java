...
import net.mcreator.themultiverseoffreddys.entity.renderer.PuppetRenderer;
...
public class PuppetEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(FNaF2TabItemGroup.tab))
