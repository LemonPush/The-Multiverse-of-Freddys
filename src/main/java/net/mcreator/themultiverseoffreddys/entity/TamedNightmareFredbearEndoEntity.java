...
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedNightmareFredbearEndoRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class TamedNightmareFredbearEndoEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.6f)).build("tamed_nightmare_fredbear_endo").setRegistryName("tamed_nightmare_fredbear_endo");

	public TamedNightmareFredbearEndoEntity(UltimateFnafModModElements instance) {
		super(instance, 1065);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedNightmareFredbearEndoRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(TapeItem.block), false));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (TapeItem.block == stack.getItem())
				return true;
			return false;
		}
	}
