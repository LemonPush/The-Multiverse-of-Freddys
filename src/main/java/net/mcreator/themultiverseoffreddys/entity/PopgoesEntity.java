...
import net.mcreator.themultiverseoffreddys.entity.renderer.PopgoesRenderer;
...
public class PopgoesEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6724096, new Item.Properties().group(PopgoesTabItemGroup.tab))
				.setRegistryName("popgoes_spawn_egg"));
	}
