...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightmareFreddyBearRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class NightmareFreddyBearEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -16777216, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("nightmare_freddy_bear_spawn_egg"));
	}
