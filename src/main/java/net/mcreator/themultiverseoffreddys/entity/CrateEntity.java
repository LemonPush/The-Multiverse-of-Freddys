...
import net.mcreator.themultiverseoffreddys.entity.renderer.CrateRenderer;
...
public class CrateEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777012, -6750208, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("crate_spawn_egg"));
	}
