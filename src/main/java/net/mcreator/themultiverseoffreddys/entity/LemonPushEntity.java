...
import net.mcreator.themultiverseoffreddys.entity.renderer.LemonPushRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class LemonPushEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -16724839, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("lemon_push_spawn_egg"));
	}
