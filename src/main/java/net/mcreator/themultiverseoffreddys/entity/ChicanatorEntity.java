...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChicanatorRenderer;
...
public class ChicanatorEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -16777216, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("chicanator_spawn_egg"));
	}
