...
import net.mcreator.themultiverseoffreddys.entity.renderer.GlamrockEndoRenderer;
...
public class GlamrockEndoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -10066330, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("glamrock_endo_spawn_egg"));
	}
