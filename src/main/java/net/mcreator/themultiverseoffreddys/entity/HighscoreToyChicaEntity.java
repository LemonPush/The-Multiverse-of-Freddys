...
import net.mcreator.themultiverseoffreddys.entity.renderer.HighscoreToyChicaRenderer;
...
public class HighscoreToyChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -16777165, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("highscore_toy_chica_spawn_egg"));
	}
