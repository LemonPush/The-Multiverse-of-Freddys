...
import net.mcreator.themultiverseoffreddys.entity.renderer.FuntimeFoxy2Renderer;
...
public class FuntimeFoxy2Entity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -26113, -1, new Item.Properties().group(FNaF2TabItemGroup.tab))
				.setRegistryName("funtime_foxy_2_spawn_egg"));
	}
