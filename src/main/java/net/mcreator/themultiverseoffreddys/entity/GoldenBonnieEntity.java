...
import net.mcreator.themultiverseoffreddys.entity.renderer.GoldenBonnieRenderer;
...
public class GoldenBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7566314, -9540080, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("golden_bonnie_spawn_egg"));
	}
