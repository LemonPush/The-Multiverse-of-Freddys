...
import net.mcreator.themultiverseoffreddys.entity.renderer.BroilerBabyRenderer;
...
public class BroilerBabyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -6737152, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("broiler_baby_spawn_egg"));
	}
