...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightmareBonnieRenderer;
...
public class NightmareBonnieEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.6f)).build("nightmare_bonnie").setRegistryName("nightmare_bonnie");

	public NightmareBonnieEntity(UltimateFnafModModElements instance) {
		super(instance, 535);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NightmareBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -16764058, new Item.Properties().group(FNaF4TabItemGroup.tab))
				.setRegistryName("nightmare_bonnie_spawn_egg"));
	}
