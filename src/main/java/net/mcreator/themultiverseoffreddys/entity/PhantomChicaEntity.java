...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomChicaRenderer;
...
public class PhantomChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14014710, -14151162, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("phantom_chica_spawn_egg"));
	}
