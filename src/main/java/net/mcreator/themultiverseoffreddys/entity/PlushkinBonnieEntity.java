...
import net.mcreator.themultiverseoffreddys.entity.renderer.PlushkinBonnieRenderer;
...
public class PlushkinBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777063, -16777165, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("plushkin_bonnie_spawn_egg"));
	}
