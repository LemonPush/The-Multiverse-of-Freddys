...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShadowMangleRenderer;
...
public class ShadowMangleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -5592406, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("shadow_mangle_spawn_egg"));
	}
