...
import net.mcreator.themultiverseoffreddys.entity.renderer.LittleRedChicaRenderer;
...
public class LittleRedChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434880, -3355444, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("little_red_chica_spawn_egg"));
	}
