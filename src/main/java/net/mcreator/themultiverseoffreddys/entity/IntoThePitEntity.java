...
import net.mcreator.themultiverseoffreddys.entity.renderer.IntoThePitRenderer;
...
public class IntoThePitEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -2039642, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("into_the_pit_spawn_egg"));
	}
