...
import net.mcreator.themultiverseoffreddys.entity.renderer.BonnieTheRabbitRenderer;
...
public class BonnieTheRabbitEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9566575, -6266187, new Item.Properties().group(FNaF1TabItemGroup.tab))
				.setRegistryName("bonnie_the_rabbit_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:bonnie1"));
		}
