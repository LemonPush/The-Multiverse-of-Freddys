...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShadowTweetieRenderer;
...
public class ShadowTweetieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -10092442, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("shadow_tweetie_spawn_egg"));
	}
