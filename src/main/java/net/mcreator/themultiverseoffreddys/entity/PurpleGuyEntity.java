...
import net.mcreator.themultiverseoffreddys.procedures.PurpleGuyEntityIsHurtProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.PurpleGuyRenderer;
...
public class PurpleGuyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14482627, -1, new Item.Properties().group(HoaxesTabItemGroup.tab))
	...
	public static class CustomEntity extends EndermanEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			PurpleGuyEntityIsHurtProcedure.executeProcedure(Stream
