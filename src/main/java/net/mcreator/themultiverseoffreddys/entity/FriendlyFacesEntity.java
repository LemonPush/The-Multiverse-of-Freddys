...
import net.mcreator.themultiverseoffreddys.entity.renderer.FriendlyFacesRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class FriendlyFacesEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -3355444, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("friendly_faces_spawn_egg"));
	}
