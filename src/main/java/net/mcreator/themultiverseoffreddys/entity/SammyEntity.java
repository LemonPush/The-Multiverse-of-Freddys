...
import net.mcreator.themultiverseoffreddys.entity.renderer.SammyRenderer;
...
public class SammyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10092442, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("sammy_spawn_egg"));
	}
