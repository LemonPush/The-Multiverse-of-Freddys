...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChocolateBonnieRenderer;
...
public class ChocolateBonnieEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("chocolate_bonnie").setRegistryName("chocolate_bonnie");

	public ChocolateBonnieEntity(UltimateFnafModModElements instance) {
		super(instance, 749);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ChocolateBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -10082304, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("chocolate_bonnie_spawn_egg"));
	}
