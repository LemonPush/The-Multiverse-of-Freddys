...
import net.mcreator.themultiverseoffreddys.entity.renderer.DisembodiedRenderer;
...
public class DisembodiedEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16777063, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("disembodied_spawn_egg"));
	}
