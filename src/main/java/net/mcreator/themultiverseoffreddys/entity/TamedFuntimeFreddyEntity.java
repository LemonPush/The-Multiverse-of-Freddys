...
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedFuntimeFreddyRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class TamedFuntimeFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.6f)).build("tamed_funtime_freddy").setRegistryName("tamed_funtime_freddy");

	public TamedFuntimeFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 1005);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedFuntimeFreddyRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(RemnantItem.block), false));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (RemnantItem.block == stack.getItem())
				return true;
			return false;
		}
	}
