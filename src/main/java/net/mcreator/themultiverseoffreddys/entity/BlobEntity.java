...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlobRenderer;
...
public class BlobEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -4276546, -1, new Item.Properties().group(FNaF9TabItemGroup.tab)).setRegistryName("blob_spawn_egg"));
	}
