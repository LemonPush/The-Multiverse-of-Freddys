...
import net.mcreator.themultiverseoffreddys.entity.renderer.TposeRenderer;
...
public class TposeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -3355648, -6750055, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("tpose_spawn_egg"));
	}
