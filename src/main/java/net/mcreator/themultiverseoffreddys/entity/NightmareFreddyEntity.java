...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightmareFreddyRenderer;
...
public class NightmareFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.6f)).build("nightmare_freddy").setRegistryName("nightmare_freddy");

	public NightmareFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 534);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NightmareFreddyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12510463, -14676221, new Item.Properties().group(FNaF4TabItemGroup.tab))
				.setRegistryName("nightmare_freddy_spawn_egg"));
	}
