...
import net.mcreator.themultiverseoffreddys.entity.renderer.RadioactiveFoxyRenderer;
...
public class RadioactiveFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10040320, -16738048, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("radioactive_foxy_spawn_egg"));
	}
