...
import net.mcreator.themultiverseoffreddys.entity.renderer.FloaterPurpleRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class FloaterPurpleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10092442, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("floater_purple_spawn_egg"));
	}
