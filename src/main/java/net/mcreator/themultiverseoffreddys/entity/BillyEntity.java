...
import net.mcreator.themultiverseoffreddys.entity.renderer.BillyRenderer;
...
public class BillyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -39424, -10027264, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("billy_spawn_egg"));
	}
