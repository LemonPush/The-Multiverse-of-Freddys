...
import net.mcreator.themultiverseoffreddys.entity.renderer.SpeedRenderer;
...
public class SpeedEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -15262706, -6710887, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("speed_spawn_egg"));
	}
