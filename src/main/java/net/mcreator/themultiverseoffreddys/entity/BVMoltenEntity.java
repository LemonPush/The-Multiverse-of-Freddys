...
import net.mcreator.themultiverseoffreddys.entity.renderer.BVMoltenRenderer;
...
public class BVMoltenEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6737152, -16777216, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("bv_molten_spawn_egg"));
	}
