...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredGoldenFreddyRenderer;
...
public class WitheredGoldenFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3169280, -9546737, new Item.Properties().group(FNaF2TabItemGroup.tab))
