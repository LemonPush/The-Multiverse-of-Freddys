...
import net.mcreator.themultiverseoffreddys.entity.renderer.Buffy2Renderer;
...
public class Buffy2Entity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -10066177, -1, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("buffy_2_spawn_egg"));
	}
