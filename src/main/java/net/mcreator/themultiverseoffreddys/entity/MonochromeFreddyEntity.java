...
import net.mcreator.themultiverseoffreddys.entity.renderer.MonochromeFreddyRenderer;
...
public class MonochromeFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -13487566, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("monochrome_freddy_spawn_egg"));
	}
