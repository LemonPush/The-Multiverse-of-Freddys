...
import net.mcreator.themultiverseoffreddys.entity.renderer.DeskManRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class DeskManEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -10066330, new Item.Properties().group(FlipSideTabItemGroup.tab))
				.setRegistryName("desk_man_spawn_egg"));
	}
