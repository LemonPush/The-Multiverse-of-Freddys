...
import net.mcreator.themultiverseoffreddys.entity.renderer.Endo01Renderer;
...
public class Endo01Entity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("endo_01").setRegistryName("endo_01");

	public Endo01Entity(UltimateFnafModModElements instance) {
		super(instance, 497);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endo01Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -13421773, new Item.Properties().group(FNaF1TabItemGroup.tab))
				.setRegistryName("endo_01_spawn_egg"));
	}
