...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlackheartBonnieRenderer;
...
public class BlackheartBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6750208, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("blackheart_bonnie_spawn_egg"));
	}
