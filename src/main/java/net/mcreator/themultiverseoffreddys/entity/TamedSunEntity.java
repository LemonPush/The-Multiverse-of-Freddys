...
import net.mcreator.themultiverseoffreddys.procedures.TamedSunRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.BatteryItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedSunRenderer;
...
public class TamedSunEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedSunRightClickedOnEntityProcedure.executeProcedure(Stream
