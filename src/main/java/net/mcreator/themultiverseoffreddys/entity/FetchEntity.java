...
import net.mcreator.themultiverseoffreddys.entity.renderer.FetchRenderer;
import net.mcreator.themultiverseoffreddys.block.FetchBodyBlock;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class FetchEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9803158, -13093581, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("fetch_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FetchBodyBlock.block));
		}
