...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChromeFreddyRenderer;
...
public class ChromeFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("chrome_freddy_spawn_egg"));
	}
