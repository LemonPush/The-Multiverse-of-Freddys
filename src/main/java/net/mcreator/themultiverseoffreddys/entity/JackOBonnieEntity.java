...
import net.mcreator.themultiverseoffreddys.entity.renderer.JackOBonnieRenderer;
...
public class JackOBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6737152, -10079488, new Item.Properties().group(FNaF4TabItemGroup.tab))
				.setRegistryName("jack_o_bonnie_spawn_egg"));
	}
