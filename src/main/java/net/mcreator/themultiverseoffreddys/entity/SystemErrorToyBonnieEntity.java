...
import net.mcreator.themultiverseoffreddys.entity.renderer.SystemErrorToyBonnieRenderer;
...
public class SystemErrorToyBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -52480, -3394816, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("system_error_toy_bonnie_spawn_egg"));
	}
