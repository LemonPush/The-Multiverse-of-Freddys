...
import net.mcreator.themultiverseoffreddys.entity.renderer.WheelchairBurntrapRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class WheelchairBurntrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15262706, -6710887, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("wheelchair_burntrap_spawn_egg"));
	}
