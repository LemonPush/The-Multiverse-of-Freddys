...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredMaxieRenderer;
...
public class WitheredMaxieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -7655766, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("withered_maxie_spawn_egg"));
	}
