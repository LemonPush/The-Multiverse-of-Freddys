...
import net.mcreator.themultiverseoffreddys.entity.renderer.ToyFreddyRenderer;
...
public class ToyFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6724096, -3381760, new Item.Properties().group(FNaF2TabItemGroup.tab))
