...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlackiceFrostbearRenderer;
...
public class BlackiceFrostbearEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("blackice_frostbear").setRegistryName("blackice_frostbear");

	public BlackiceFrostbearEntity(UltimateFnafModModElements instance) {
		super(instance, 790);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlackiceFrostbearRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751002, -16737895, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("blackice_frostbear_spawn_egg"));
	}
