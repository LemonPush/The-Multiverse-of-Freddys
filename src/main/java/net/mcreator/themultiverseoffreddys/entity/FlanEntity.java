...
import net.mcreator.themultiverseoffreddys.entity.renderer.FlanRenderer;
...
public class FlanEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16737946, -16737997, new Item.Properties().group(F2ItemGroup.tab)).setRegistryName("flan_spawn_egg"));
	}
