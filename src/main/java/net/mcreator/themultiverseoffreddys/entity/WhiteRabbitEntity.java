...
import net.mcreator.themultiverseoffreddys.entity.renderer.WhiteRabbitRenderer;
...
public class WhiteRabbitEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("white_rabbit_spawn_egg"));
	}
