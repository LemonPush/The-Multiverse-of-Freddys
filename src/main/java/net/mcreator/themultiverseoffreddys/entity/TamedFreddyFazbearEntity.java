...
import net.mcreator.themultiverseoffreddys.procedures.TamedFreddyFazbearRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.PizzaItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedFreddyFazbearRenderer;
...
public class TamedFreddyFazbearEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("tamed_freddy_fazbear").setRegistryName("tamed_freddy_fazbear");

	public TamedFreddyFazbearEntity(UltimateFnafModModElements instance) {
		super(instance, 930);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedFreddyFazbearRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(PizzaItem.block), false));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedFreddyFazbearRightClickedOnEntityProcedure.executeProcedure(Stream
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (PizzaItem.block == stack.getItem())
				return true;
			return false;
		}
	}
