...
import net.mcreator.themultiverseoffreddys.entity.renderer.XmanRenderer;
...
public class XmanEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -3407668, -10092340, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("xman_spawn_egg"));
	}
