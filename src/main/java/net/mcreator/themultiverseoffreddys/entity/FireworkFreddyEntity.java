...
import net.mcreator.themultiverseoffreddys.entity.renderer.FireworkFreddyRenderer;
...
public class FireworkFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -6750208, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("firework_freddy_spawn_egg"));
	}
