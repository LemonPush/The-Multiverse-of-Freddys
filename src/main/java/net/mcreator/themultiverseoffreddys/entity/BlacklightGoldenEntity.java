...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlacklightGoldenRenderer;
...
public class BlacklightGoldenEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7566314, -10092493, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("blacklight_golden_spawn_egg"));
	}
