...
import net.mcreator.themultiverseoffreddys.entity.renderer.SnowconeRenderer;
...
public class SnowconeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -16777012, new Item.Properties().group(F2ItemGroup.tab)).setRegistryName("snowcone_spawn_egg"));
	}
