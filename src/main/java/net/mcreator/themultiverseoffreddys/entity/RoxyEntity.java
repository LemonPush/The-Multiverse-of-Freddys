...
import net.mcreator.themultiverseoffreddys.entity.renderer.RoxyRenderer;
...
public class RoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -10092442, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("roxy_spawn_egg"));
	}
