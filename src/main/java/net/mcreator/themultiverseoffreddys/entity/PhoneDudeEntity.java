...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhoneDudeRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class PhoneDudeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724941, -13408768, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("phone_dude_spawn_egg"));
	}
