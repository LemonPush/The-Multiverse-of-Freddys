...
import net.mcreator.themultiverseoffreddys.entity.renderer.LonelyFreddyRenderer;
import net.mcreator.themultiverseoffreddys.block.LonelyFreddyBodyBlock;
...
public class LonelyFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -16777063, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("lonely_freddy_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(LonelyFreddyBodyBlock.block));
		}
