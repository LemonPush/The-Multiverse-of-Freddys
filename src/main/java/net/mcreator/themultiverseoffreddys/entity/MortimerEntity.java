...
import net.mcreator.themultiverseoffreddys.entity.renderer.MortimerRenderer;
...
public class MortimerEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("mortimer_spawn_egg"));
	}
