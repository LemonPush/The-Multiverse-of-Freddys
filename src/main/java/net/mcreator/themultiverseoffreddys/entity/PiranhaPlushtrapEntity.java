...
import net.mcreator.themultiverseoffreddys.entity.renderer.PiranhaPlushtrapRenderer;
...
public class PiranhaPlushtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -16738048, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("piranha_plushtrap_spawn_egg"));
	}
