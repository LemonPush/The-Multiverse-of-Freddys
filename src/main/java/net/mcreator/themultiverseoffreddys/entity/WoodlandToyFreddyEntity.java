...
import net.mcreator.themultiverseoffreddys.entity.renderer.WoodlandToyFreddyRenderer;
...
public class WoodlandToyFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6737152, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("woodland_toy_freddy_spawn_egg"));
	}
