...
import net.mcreator.themultiverseoffreddys.entity.renderer.FrostbearRenderer;
...
public class FrostbearEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737895, -16724788, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("frostbear_spawn_egg"));
	}
