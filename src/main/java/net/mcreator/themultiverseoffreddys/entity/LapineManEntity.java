...
import net.mcreator.themultiverseoffreddys.item.DragonStickItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.LapineManRenderer;
...
public class LapineManEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421824, -16764160, new Item.Properties().group(F4ItemGroup.tab))
				.setRegistryName("lapine_man_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(DragonStickItem.block));
		}
