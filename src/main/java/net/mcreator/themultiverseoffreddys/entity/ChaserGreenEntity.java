...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChaserGreenRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class ChaserGreenEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13395712, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("chaser_green_spawn_egg"));
	}
