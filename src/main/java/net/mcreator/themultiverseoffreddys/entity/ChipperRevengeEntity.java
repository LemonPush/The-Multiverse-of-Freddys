...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChipperRevengeRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class ChipperRevengeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7994878, -6710887, new Item.Properties().group(F5ItemGroup.tab))
				.setRegistryName("chipper_revenge_spawn_egg"));
	}
