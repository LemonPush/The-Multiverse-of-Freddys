...
import net.mcreator.themultiverseoffreddys.entity.renderer.CandyCadetRenderer;
...
public class CandyCadetEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -16777216, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("candy_cadet_spawn_egg"));
	}
