...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShadowMaxieRenderer;
...
public class ShadowMaxieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -13434829, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("shadow_maxie_spawn_egg"));
	}
