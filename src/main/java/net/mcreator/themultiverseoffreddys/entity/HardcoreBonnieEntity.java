...
import net.mcreator.themultiverseoffreddys.entity.renderer.HardcoreBonnieRenderer;
...
public class HardcoreBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -3342388, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("hardcore_bonnie_spawn_egg"));
	}
