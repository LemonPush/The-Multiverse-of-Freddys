...
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedPhantomFreddyRenderer;
...
public class TamedPhantomFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("tamed_phantom_freddy").setRegistryName("tamed_phantom_freddy");

	public TamedPhantomFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 971);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedPhantomFreddyRenderer.ModelRegisterHandler());
