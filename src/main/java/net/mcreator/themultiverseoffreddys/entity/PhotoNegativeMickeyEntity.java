...
import net.mcreator.themultiverseoffreddys.itemgroup.TreasureTabItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.PhotoNegativeMickeyRenderer;
...
public class PhotoNegativeMickeyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -14042210, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("photo_negative_mickey_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:death_ti"));
		}
