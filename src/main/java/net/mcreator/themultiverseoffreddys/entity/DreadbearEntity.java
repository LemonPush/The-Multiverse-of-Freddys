...
import net.mcreator.themultiverseoffreddys.entity.renderer.DreadbearRenderer;
...
public class DreadbearEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11575541, -16777216, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("dreadbear_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:dreadbear4"));
		}
