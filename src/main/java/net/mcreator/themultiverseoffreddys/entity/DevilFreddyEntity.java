...
import net.mcreator.themultiverseoffreddys.entity.renderer.DevilFreddyRenderer;
...
public class DevilFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750208, -10092544, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("devil_freddy_spawn_egg"));
	}
