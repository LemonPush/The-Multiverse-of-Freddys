...
import net.mcreator.themultiverseoffreddys.entity.renderer.MrHippoRenderer;
...
public class MrHippoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -13434829, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("mr_hippo_spawn_egg"));
	}
