...
import net.mcreator.themultiverseoffreddys.entity.renderer.DeeDeeRenderer;
...
public class DeeDeeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4194100, -11136133, new Item.Properties().group(FNaF7TabItemGroup.tab))
				.setRegistryName("dee_dee_spawn_egg"));
	}
