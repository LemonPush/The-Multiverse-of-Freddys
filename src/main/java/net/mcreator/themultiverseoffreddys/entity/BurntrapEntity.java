...
import net.mcreator.themultiverseoffreddys.entity.renderer.BurntrapRenderer;
...
public class BurntrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15262706, -14475746, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("burntrap_spawn_egg"));
	}
