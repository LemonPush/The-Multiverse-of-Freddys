...
import net.mcreator.themultiverseoffreddys.entity.renderer.FelixTheSharkRenderer;
...
public class FelixTheSharkEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13744378, -9803158, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("felix_the_shark_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 2, 1, 1));
	}
