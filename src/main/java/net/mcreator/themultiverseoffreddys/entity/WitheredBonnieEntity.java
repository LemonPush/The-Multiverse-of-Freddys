...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredBonnieRenderer;
...
public class WitheredBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15529355, -13300107, new Item.Properties().group(FNaF2TabItemGroup.tab))
