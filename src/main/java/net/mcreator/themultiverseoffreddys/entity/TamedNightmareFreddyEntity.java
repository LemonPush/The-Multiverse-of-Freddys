...
import net.mcreator.themultiverseoffreddys.procedures.TamedNightmareFreddyEntityIsHurtProcedure;
import net.mcreator.themultiverseoffreddys.item.IllusionDiscItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedNightmareFreddyRenderer;
...
public class TamedNightmareFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.6f)).build("tamed_nightmare_freddy").setRegistryName("tamed_nightmare_freddy");

	public TamedNightmareFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 981);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedNightmareFreddyRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(IllusionDiscItem.block), false));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TamedNightmareFreddyEntityIsHurtProcedure.executeProcedure(Stream
