...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShadowBBRenderer;
...
public class ShadowBBEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("shadow_bb_spawn_egg"));
	}
