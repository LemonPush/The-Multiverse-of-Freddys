...
import net.mcreator.themultiverseoffreddys.entity.renderer.CoffeeRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class CoffeeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -3355444, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("coffee_spawn_egg"));
	}
