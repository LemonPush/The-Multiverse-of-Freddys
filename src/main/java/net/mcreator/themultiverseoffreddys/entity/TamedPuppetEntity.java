...
import net.mcreator.themultiverseoffreddys.procedures.TamedPuppetRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.SodaItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedPuppetRenderer;
...
public class TamedPuppetEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedPuppetRightClickedOnEntityProcedure.executeProcedure(Stream
