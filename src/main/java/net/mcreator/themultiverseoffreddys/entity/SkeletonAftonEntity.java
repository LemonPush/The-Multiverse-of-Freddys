...
import net.mcreator.themultiverseoffreddys.procedures.SkeletonAftonEntityDiesProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.FFTabItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.SkeletonAftonRenderer;
...
public class SkeletonAftonEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -3355444, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("skeleton_afton_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			SkeletonAftonEntityDiesProcedure.executeProcedure(Stream
