...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomBalloonBoyRenderer;
...
public class PhantomBalloonBoyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434870, -16448247, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("phantom_balloon_boy_spawn_egg"));
	}
