...
import net.mcreator.themultiverseoffreddys.entity.renderer.CatRenderer;
...
public class CatEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10197916, -13885419, new Item.Properties().group(CandyTabItemGroup.tab))
