...
import net.mcreator.themultiverseoffreddys.entity.renderer.CreationRenderer;
...
public class CreationEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -10066330, new Item.Properties().group(TJoCTabItemGroup.tab))
				.setRegistryName("creation_spawn_egg"));
	}
