...
import net.mcreator.themultiverseoffreddys.entity.renderer.PirateWolfRenderer;
...
public class PirateWolfEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -6710887, -1, new Item.Properties().group(F2ItemGroup.tab)).setRegistryName("pirate_wolf_spawn_egg"));
	}
