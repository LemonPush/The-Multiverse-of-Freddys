...
import net.mcreator.themultiverseoffreddys.entity.renderer.UglyFoxyRenderer;
...
public class UglyFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750208, -52429, new Item.Properties().group(F4ItemGroup.tab))
				.setRegistryName("ugly_foxy_spawn_egg"));
	}
