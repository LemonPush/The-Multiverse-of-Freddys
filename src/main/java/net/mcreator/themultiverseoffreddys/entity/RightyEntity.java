...
import net.mcreator.themultiverseoffreddys.entity.renderer.RightyRenderer;
...
public class RightyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -16405851, new Item.Properties().group(F3ItemGroup.tab)).setRegistryName("righty_spawn_egg"));
	}
