...
import net.mcreator.themultiverseoffreddys.entity.renderer.CircusBabyRenderer;
...
public class CircusBabyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750208, -1, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("circus_baby_spawn_egg"));
	}
