...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomToyChicaRenderer;
...
public class PhantomToyChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14014710, -14151162, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("phantom_toy_chica_spawn_egg"));
	}
