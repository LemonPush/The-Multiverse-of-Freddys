...
import net.mcreator.themultiverseoffreddys.entity.renderer.SimonRenderer;
...
public class SimonEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -16777216, new Item.Properties().group(PopgoesTabItemGroup.tab))
				.setRegistryName("simon_spawn_egg"));
	}
