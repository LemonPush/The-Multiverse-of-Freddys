...
import net.mcreator.themultiverseoffreddys.entity.renderer.SpringBonnieRenderer;
...
public class SpringBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -10066432, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("spring_bonnie_spawn_egg"));
	}
