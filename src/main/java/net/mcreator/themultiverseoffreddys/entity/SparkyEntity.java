...
import net.mcreator.themultiverseoffreddys.entity.renderer.SparkyRenderer;
...
public class SparkyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -10995172, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("sparky_spawn_egg"));
	}
