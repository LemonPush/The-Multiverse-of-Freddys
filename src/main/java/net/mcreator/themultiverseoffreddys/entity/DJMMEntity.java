...
import net.mcreator.themultiverseoffreddys.procedures.FNaF9LootProcedure;
import net.mcreator.themultiverseoffreddys.procedures.BiomeSpawnProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.FNaF9TabItemGroup;
import net.mcreator.themultiverseoffreddys.item.BatteryItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.DJMMRenderer;
...
public class DJMMEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4276546, -6750055, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("djmm_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BatteryItem.block));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:walk_big"));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:death9"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			FNaF9LootProcedure.executeProcedure(Stream
