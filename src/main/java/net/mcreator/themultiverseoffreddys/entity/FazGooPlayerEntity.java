...
import net.mcreator.themultiverseoffreddys.procedures.FazGooRightClickProcedure;
import net.mcreator.themultiverseoffreddys.procedures.FazGooInitialProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.FazGooPlayerRenderer;
...
public class FazGooPlayerEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -3407719, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("faz_goo_player_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("ultimate_fnaf_mod:infested").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(FazGooItem.block), false));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			FazGooRightClickProcedure.executeProcedure(Stream
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (FazGooItem.block == stack.getItem())
				return true;
			return false;
		}
	}
