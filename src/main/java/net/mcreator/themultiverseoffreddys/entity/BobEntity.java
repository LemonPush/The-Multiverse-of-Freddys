...
import net.mcreator.themultiverseoffreddys.entity.renderer.BobRenderer;
...
public class BobEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -3368704, -3355444, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("bob_spawn_egg"));
	}
