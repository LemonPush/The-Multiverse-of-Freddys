...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightmareChicaRenderer;
...
public class NightmareChicaEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.6f)).build("nightmare_chica").setRegistryName("nightmare_chica");

	public NightmareChicaEntity(UltimateFnafModModElements instance) {
		super(instance, 536);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NightmareChicaRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066432, -6737152, new Item.Properties().group(FNaF4TabItemGroup.tab))
				.setRegistryName("nightmare_chica_spawn_egg"));
	}
