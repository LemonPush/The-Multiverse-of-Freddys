...
import net.mcreator.themultiverseoffreddys.entity.renderer.SecurityRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class SecurityEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7929856, -6710887, new Item.Properties().group(F5ItemGroup.tab))
				.setRegistryName("security_spawn_egg"));
	}
