...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredGeorgeRenderer;
...
public class WitheredGeorgeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2435669, -3565959, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("withered_george_spawn_egg"));
	}
