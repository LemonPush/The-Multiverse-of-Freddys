...
import net.mcreator.themultiverseoffreddys.entity.renderer.RockstarFreddyRenderer;
...
public class RockstarFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8694000, -10077952, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("rockstar_freddy_spawn_egg"));
	}
