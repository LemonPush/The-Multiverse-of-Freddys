...
import net.mcreator.themultiverseoffreddys.entity.renderer.OMCRenderer;
...
public class OMCEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -10222845, new Item.Properties().group(FNaF7TabItemGroup.tab))
				.setRegistryName("omc_spawn_egg"));
	}
