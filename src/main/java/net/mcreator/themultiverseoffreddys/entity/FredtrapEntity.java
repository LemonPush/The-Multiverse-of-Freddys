...
import net.mcreator.themultiverseoffreddys.procedures.FredtrapEntityIsHurtProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.FredtrapRenderer;
...
public class FredtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764160, -13408768, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("fredtrap_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(HeadlessFoxyBlock.block));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			FredtrapEntityIsHurtProcedure.executeProcedure(Stream
