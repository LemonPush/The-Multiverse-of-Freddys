...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChillaxRenderer;
...
public class ChillaxEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777012, -10066330, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("chillax_spawn_egg"));
	}
