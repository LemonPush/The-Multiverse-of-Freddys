...
import net.mcreator.themultiverseoffreddys.entity.renderer.BigBadFoxyRenderer;
...
public class BigBadFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092544, -13421773, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("big_bad_foxy_spawn_egg"));
	}
