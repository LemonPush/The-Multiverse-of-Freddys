...
import net.mcreator.themultiverseoffreddys.entity.renderer.BVGoldenRenderer;
...
public class BVGoldenEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -16777216, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("bv_golden_spawn_egg"));
	}
