...
import net.mcreator.themultiverseoffreddys.entity.renderer.DreamgeistRenderer;
...
public class DreamgeistEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777165, -13421773, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("dreamgeist_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ChipSpeedItem.block));
		}
