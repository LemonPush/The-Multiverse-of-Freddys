...
import net.mcreator.themultiverseoffreddys.procedures.ToBeBeautifulRightClickedOnEntityProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.ToBeBeautifulRenderer;
...
public class ToBeBeautifulEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3205610, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("to_be_beautiful_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(EleanorBodyBlock.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			ToBeBeautifulRightClickedOnEntityProcedure.executeProcedure(Stream
