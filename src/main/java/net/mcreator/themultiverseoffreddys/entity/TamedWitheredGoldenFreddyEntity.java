...
import net.mcreator.themultiverseoffreddys.procedures.TamedWitheredGoldenFreddyRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.SodaItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedWitheredGoldenFreddyRenderer;
...
public class TamedWitheredGoldenFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedWitheredGoldenFreddyRightClickedOnEntityProcedure.executeProcedure(Stream
