...
import net.mcreator.themultiverseoffreddys.entity.renderer.NeddBearRenderer;
...
public class NeddBearEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7252480, -6329029, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("nedd_bear_spawn_egg"));
	}
