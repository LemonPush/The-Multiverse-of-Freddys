...
import net.mcreator.themultiverseoffreddys.entity.renderer.SecurityOwlRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class SecurityOwlEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -6710887, new Item.Properties().group(F5ItemGroup.tab))
				.setRegistryName("security_owl_spawn_egg"));
	}
