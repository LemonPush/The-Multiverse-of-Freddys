...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChaserRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class ChaserEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(F1ItemGroup.tab)).setRegistryName("chaser_spawn_egg"));
	}
