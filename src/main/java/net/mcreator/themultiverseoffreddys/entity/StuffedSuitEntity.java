...
import net.mcreator.themultiverseoffreddys.entity.renderer.StuffedSuitRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class StuffedSuitEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -13434880, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("stuffed_suit_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.fromItems(PizzaItem.block), false));
