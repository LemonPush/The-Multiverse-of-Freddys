...
import net.mcreator.themultiverseoffreddys.entity.renderer.PlushScrapBabyYellowRenderer;
...
public class PlushScrapBabyYellowEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6512875, -1, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("plush_scrap_baby_yellow_spawn_egg"));
	}
