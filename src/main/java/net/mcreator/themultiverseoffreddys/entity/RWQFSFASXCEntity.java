...
import net.mcreator.themultiverseoffreddys.entity.renderer.RWQFSFASXCRenderer;
...
public class RWQFSFASXCEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("rwqfsfasxc_spawn_egg"));
	}
