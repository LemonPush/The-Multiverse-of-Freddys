...
import net.mcreator.themultiverseoffreddys.entity.renderer.TangleRenderer;
...
public class TangleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -16738048, new Item.Properties().group(F2ItemGroup.tab)).setRegistryName("tangle_spawn_egg"));
	}
