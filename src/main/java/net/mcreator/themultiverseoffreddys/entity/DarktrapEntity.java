...
import net.mcreator.themultiverseoffreddys.procedures.SpringtrapLootProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.DarktrapRenderer;
...
public class DarktrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12957638, -11183026, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("darktrap_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PossessedMetalItem.block));
		}
		...
		public void onDeath(DamageSource source) {
			...
			SpringtrapLootProcedure.executeProcedure(Stream
