...
import net.mcreator.themultiverseoffreddys.entity.renderer.MichaelRenderer;
...
public class MichaelEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -16318413, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("michael_spawn_egg"));
	}
