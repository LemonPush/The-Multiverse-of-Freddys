...
import net.mcreator.themultiverseoffreddys.entity.renderer.ToyChicaRenderer;
...
public class ToyChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1520340, -1489396, new Item.Properties().group(FNaF2TabItemGroup.tab))
