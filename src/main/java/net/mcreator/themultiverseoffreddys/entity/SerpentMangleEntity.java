...
import net.mcreator.themultiverseoffreddys.entity.renderer.SerpentMangleRenderer;
...
public class SerpentMangleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -16724890, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("serpent_mangle_spawn_egg"));
	}
