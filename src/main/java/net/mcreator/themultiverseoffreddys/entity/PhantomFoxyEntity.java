...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomFoxyRenderer;
...
public class PhantomFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14809335, -14674167, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("phantom_foxy_spawn_egg"));
	}
