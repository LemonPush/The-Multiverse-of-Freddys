...
import net.mcreator.themultiverseoffreddys.entity.renderer.RatRenderer;
...
public class RatEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10197916, -12376563, new Item.Properties().group(CandyTabItemGroup.tab))
