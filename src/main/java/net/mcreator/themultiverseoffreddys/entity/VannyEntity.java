...
import net.mcreator.themultiverseoffreddys.entity.renderer.VannyRenderer;
...
public class VannyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -6750208, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("vanny_spawn_egg"));
	}
