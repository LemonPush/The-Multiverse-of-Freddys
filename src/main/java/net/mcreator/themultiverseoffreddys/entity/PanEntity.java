...
import net.mcreator.themultiverseoffreddys.entity.renderer.PanRenderer;
...
public class PanEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -3355444, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("pan_spawn_egg"));
	}
