...
import net.mcreator.themultiverseoffreddys.entity.renderer.EnnardRenderer;
...
public class EnnardEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -6579301, -1, new Item.Properties().group(FNaF5TabItemGroup.tab)).setRegistryName("ennard_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(IceCreamItem.block));
		}
