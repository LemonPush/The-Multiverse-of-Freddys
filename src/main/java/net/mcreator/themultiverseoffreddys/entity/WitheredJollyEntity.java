...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredJollyRenderer;
...
public class WitheredJollyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434880, -5925253, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("withered_jolly_spawn_egg"));
	}
