...
import net.mcreator.themultiverseoffreddys.entity.renderer.CleanBotRenderer;
...
public class CleanBotEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -205, -3355444, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("clean_bot_spawn_egg"));
	}
