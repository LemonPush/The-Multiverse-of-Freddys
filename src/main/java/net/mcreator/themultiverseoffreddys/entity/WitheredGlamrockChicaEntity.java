...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredGlamrockChicaRenderer;
...
public class WitheredGlamrockChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3407668, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("withered_glamrock_chica_spawn_egg"));
	}
