...
import net.mcreator.themultiverseoffreddys.entity.renderer.BunnyCallRenderer;
...
public class BunnyCallEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6711040, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("bunny_call_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RalphoPlushBlock.block));
		}
