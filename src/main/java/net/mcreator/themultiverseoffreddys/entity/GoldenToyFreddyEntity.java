...
import net.mcreator.themultiverseoffreddys.entity.renderer.GoldenToyFreddyRenderer;
...
public class GoldenToyFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4211442, -1777124, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("golden_toy_freddy_spawn_egg"));
	}
