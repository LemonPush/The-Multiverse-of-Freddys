...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlackBirdRenderer;
import net.mcreator.themultiverseoffreddys.block.BlackbirdBodyBlock;
...
public class BlackBirdEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("black_bird_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BlackbirdBodyBlock.block));
		}
