...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomFreddyRenderer;
...
public class PhantomFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("phantom_freddy").setRegistryName("phantom_freddy");

	public PhantomFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 508);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PhantomFreddyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16050686, -16579328, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("phantom_freddy_spawn_egg"));
	}
