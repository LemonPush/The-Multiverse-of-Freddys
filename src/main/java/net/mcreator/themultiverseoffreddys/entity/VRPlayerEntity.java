...
import net.mcreator.themultiverseoffreddys.entity.renderer.VRPlayerRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class VRPlayerEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -15269595, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("vr_player_spawn_egg"));
	}
