...
import net.mcreator.themultiverseoffreddys.procedures.TamedSpringtraphurtProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.GamesSpringtrapRenderer;
...
public class GamesSpringtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -256, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("games_springtrap_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TamedSpringtraphurtProcedure.executeProcedure(Stream
