...
import net.mcreator.themultiverseoffreddys.entity.renderer.CurseRenderer;
...
public class CurseEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751053, -6711040, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("curse_spawn_egg"));
	}
