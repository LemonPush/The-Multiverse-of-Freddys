...
import net.mcreator.themultiverseoffreddys.entity.renderer.BuffHelpyRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class BuffHelpyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -13159, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("buff_helpy_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.fromItems(PartyHatItem.block), false));
