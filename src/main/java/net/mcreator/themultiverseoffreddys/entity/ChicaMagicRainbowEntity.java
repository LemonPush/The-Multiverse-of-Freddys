...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChicaMagicRainbowRenderer;
...
public class ChicaMagicRainbowEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -65383, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("chica_magic_rainbow_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ChipRegenItem.block));
		}
