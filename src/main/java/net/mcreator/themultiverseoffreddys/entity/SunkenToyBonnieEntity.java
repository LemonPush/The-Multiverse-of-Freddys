...
import net.mcreator.themultiverseoffreddys.entity.renderer.SunkenToyBonnieRenderer;
...
public class SunkenToyBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -16724788, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("sunken_toy_bonnie_spawn_egg"));
	}
