...
import net.mcreator.themultiverseoffreddys.entity.renderer.Endo02Renderer;
...
public class Endo02Entity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12303292, -11842741, new Item.Properties().group(FNaF2TabItemGroup.tab))
