...
import net.mcreator.themultiverseoffreddys.entity.renderer.AcephalousRenderer;
...
public class AcephalousEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14804089, -5288940, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("acephalous_spawn_egg"));
	}
