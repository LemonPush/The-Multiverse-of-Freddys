...
import net.mcreator.themultiverseoffreddys.entity.renderer.PuppetCarverRenderer;
...
public class PuppetCarverEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13159, -10079488, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("puppet_carver_spawn_egg"));
	}
