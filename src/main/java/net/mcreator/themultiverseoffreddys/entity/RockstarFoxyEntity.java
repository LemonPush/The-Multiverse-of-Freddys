...
import net.mcreator.themultiverseoffreddys.entity.renderer.RockstarFoxyRenderer;
...
public class RockstarFoxyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("rockstar_foxy").setRegistryName("rockstar_foxy");

	public RockstarFoxyEntity(UltimateFnafModModElements instance) {
		super(instance, 604);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RockstarFoxyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1960169, -6547689, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("rockstar_foxy_spawn_egg"));
	}
