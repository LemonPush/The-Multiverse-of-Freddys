...
import net.mcreator.themultiverseoffreddys.entity.renderer.TrappedAftonRenderer;
...
public class TrappedAftonEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066432, -13434880, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("trapped_afton_spawn_egg"));
	}
