...
import net.mcreator.themultiverseoffreddys.entity.renderer.GoldenFreddyRenderer;
...
public class GoldenFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("golden_freddy").setRegistryName("golden_freddy");

	public GoldenFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 495);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7566314, -9540080, new Item.Properties().group(FNaF1TabItemGroup.tab))
	...
	public static class CustomEntity extends EndermanEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:golden1"));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:deathgolden1"));
		}
