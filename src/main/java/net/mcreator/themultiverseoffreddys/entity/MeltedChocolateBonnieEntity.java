...
import net.mcreator.themultiverseoffreddys.entity.renderer.MeltedChocolateBonnieRenderer;
...
public class MeltedChocolateBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12049408, -11263744, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("melted_chocolate_bonnie_spawn_egg"));
	}
