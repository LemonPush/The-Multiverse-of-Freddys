...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightmareFredbearEndoRenderer;
...
public class NightmareFredbearEndoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12171706, -9079435, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("nightmare_fredbear_endo_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TapeItem.block));
		}
