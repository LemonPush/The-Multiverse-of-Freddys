...
import net.mcreator.themultiverseoffreddys.entity.renderer.MoonRenderer;
...
public class MoonEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -16777063, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("moon_spawn_egg"));
	}
