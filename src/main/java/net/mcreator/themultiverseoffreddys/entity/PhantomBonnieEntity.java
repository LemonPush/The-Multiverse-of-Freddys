...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomBonnieRenderer;
...
public class PhantomBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764160, -16764109, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("phantom_bonnie_spawn_egg"));
	}
