...
import net.mcreator.themultiverseoffreddys.entity.renderer.GlamrockFreddyRenderer;
...
public class GlamrockFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6724096, -6750208, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("glamrock_freddy_spawn_egg"));
	}
