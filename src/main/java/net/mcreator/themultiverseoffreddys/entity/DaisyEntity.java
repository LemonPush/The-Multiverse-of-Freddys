...
import net.mcreator.themultiverseoffreddys.entity.renderer.DaisyRenderer;
...
public class DaisyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3407668, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("daisy_spawn_egg"));
	}
