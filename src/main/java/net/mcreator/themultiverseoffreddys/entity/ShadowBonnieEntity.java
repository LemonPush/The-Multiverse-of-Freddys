...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShadowBonnieRenderer;
...
public class ShadowBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(FNaF3TabItemGroup.tab))
