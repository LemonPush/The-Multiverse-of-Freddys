...
import net.mcreator.themultiverseoffreddys.entity.renderer.GlitchtrapRenderer;
...
public class GlitchtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066432, -5921429, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("glitchtrap_spawn_egg"));
	}
