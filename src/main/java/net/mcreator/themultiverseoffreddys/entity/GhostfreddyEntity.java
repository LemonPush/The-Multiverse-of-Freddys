...
import net.mcreator.themultiverseoffreddys.entity.renderer.GhostfreddyRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class GhostfreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10053121, -6697729, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("ghostfreddy_spawn_egg"));
	}
