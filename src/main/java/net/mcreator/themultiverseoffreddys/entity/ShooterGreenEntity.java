...
import net.mcreator.themultiverseoffreddys.item.AgonyShootItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.ShooterGreenRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class ShooterGreenEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13408768, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("shooter_green_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			AgonyShootItem.shoot(this, target);
		}
	}
}
