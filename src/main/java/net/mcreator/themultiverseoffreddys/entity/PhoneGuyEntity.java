...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhoneGuyRenderer;
...
public class PhoneGuyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15002477, -14213253, new Item.Properties().group(FNaF7TabItemGroup.tab))
				.setRegistryName("phone_guy_spawn_egg"));
	}
