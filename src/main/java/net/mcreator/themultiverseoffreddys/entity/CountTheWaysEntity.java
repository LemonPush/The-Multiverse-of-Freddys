...
import net.mcreator.themultiverseoffreddys.entity.renderer.CountTheWaysRenderer;
import net.mcreator.themultiverseoffreddys.block.FuntimeFreddyBodyBlock;
...
public class CountTheWaysEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -13434829, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("count_the_ways_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FuntimeFreddyBodyBlock.block));
		}
