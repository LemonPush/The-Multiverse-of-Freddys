...
import net.mcreator.themultiverseoffreddys.entity.renderer.BouncePotRenderer;
...
public class BouncePotEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13395712, -9286881, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("bounce_pot_spawn_egg"));
	}
