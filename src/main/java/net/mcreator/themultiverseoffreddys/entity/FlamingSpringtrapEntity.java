...
import net.mcreator.themultiverseoffreddys.procedures.FlamingSpringtrapPlayerCollidesWithThisEntityProcedure;
import net.mcreator.themultiverseoffreddys.procedures.FlamingSpringtrapOnEntityTickUpdateProcedure;
import net.mcreator.themultiverseoffreddys.procedures.BiomeSpawnProcedure;
import net.mcreator.themultiverseoffreddys.procedures.ARLootProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.FlamingSpringtrapRenderer;
...
public class FlamingSpringtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -3381760, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("flaming_springtrap_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FazcoinItem.block));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:death_ar"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			ARLootProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			FlamingSpringtrapOnEntityTickUpdateProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			FlamingSpringtrapPlayerCollidesWithThisEntityProcedure
