...
import net.mcreator.themultiverseoffreddys.entity.renderer.ScrapBalloraRenderer;
...
public class ScrapBalloraEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -16777063, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("scrap_ballora_spawn_egg"));
	}
