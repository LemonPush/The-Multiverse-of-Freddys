...
import net.mcreator.themultiverseoffreddys.entity.renderer.FuntimeFreddyRenderer;
...
public class FuntimeFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -13434829, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("funtime_freddy_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:freddy5"));
		}
