...
import net.mcreator.themultiverseoffreddys.entity.renderer.HenryRenderer;
...
public class HenryEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16738048, -16737997, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("henry_spawn_egg"));
	}
