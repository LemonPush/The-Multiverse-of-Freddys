...
import net.mcreator.themultiverseoffreddys.entity.renderer.IgnitedFreddyRenderer;
...
public class IgnitedFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9155069, -9554176, new Item.Properties().group(TJoCTabItemGroup.tab))
				.setRegistryName("ignited_freddy_spawn_egg"));
	}
