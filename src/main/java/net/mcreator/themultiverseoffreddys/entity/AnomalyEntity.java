...
import net.mcreator.themultiverseoffreddys.procedures.GlitchLootProcedure;
import net.mcreator.themultiverseoffreddys.procedures.AnomalyEntityIsHurtProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.F1ItemGroup;
import net.mcreator.themultiverseoffreddys.item.AgonyTrophyItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.AnomalyRenderer;
...
public class AnomalyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10092442, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("anomaly_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(AgonyTrophyItem.block));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:deadeyes"));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			AnomalyEntityIsHurtProcedure.executeProcedure(Stream
		...
		public void onDeath(DamageSource source) {
			...
			GlitchLootProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
