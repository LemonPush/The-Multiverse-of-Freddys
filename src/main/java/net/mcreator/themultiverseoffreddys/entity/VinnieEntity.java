...
import net.mcreator.themultiverseoffreddys.entity.renderer.VinnieRenderer;
...
public class VinnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -3881788, new Item.Properties().group(CandyTabItemGroup.tab))
				.setRegistryName("vinnie_spawn_egg"));
	}
