...
import net.mcreator.themultiverseoffreddys.entity.renderer.IgnitedFoxyRenderer;
...
public class IgnitedFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434880, -10092544, new Item.Properties().group(TJoCTabItemGroup.tab))
				.setRegistryName("ignited_foxy_spawn_egg"));
	}
