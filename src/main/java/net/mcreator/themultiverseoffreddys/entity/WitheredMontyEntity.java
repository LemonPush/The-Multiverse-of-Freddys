...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredMontyRenderer;
...
public class WitheredMontyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13395712, -3355648, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("withered_monty_spawn_egg"));
	}
