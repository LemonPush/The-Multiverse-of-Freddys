...
import net.mcreator.themultiverseoffreddys.entity.renderer.InTheFleshRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class InTheFleshEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14865657, -14274037, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("in_the_flesh_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BabyBottleItem.block));
		}
