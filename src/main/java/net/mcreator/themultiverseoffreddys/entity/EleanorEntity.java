...
import net.mcreator.themultiverseoffreddys.procedures.FFLootProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.EleanorRenderer;
...
public class EleanorEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13760945, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("eleanor_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(HeartPendantItem.block));
		}
		...
		public void onDeath(DamageSource source) {
			...
			FFLootProcedure.executeProcedure(Stream
