...
import net.mcreator.themultiverseoffreddys.entity.renderer.BalloraRenderer;
...
public class BalloraEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16776961, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("ballora_spawn_egg"));
	}
