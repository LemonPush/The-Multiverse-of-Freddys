...
import net.mcreator.themultiverseoffreddys.entity.renderer.CharlotteRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class CharlotteEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("charlotte_spawn_egg"));
	}
