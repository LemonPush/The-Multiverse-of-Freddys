...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChaserPurpleRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class ChaserPurpleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10092442, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("chaser_purple_spawn_egg"));
	}
