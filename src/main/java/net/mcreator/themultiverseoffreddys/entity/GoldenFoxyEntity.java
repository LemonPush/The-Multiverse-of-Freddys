...
import net.mcreator.themultiverseoffreddys.entity.renderer.GoldenFoxyRenderer;
...
public class GoldenFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -13421824, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("golden_foxy_spawn_egg"));
	}
