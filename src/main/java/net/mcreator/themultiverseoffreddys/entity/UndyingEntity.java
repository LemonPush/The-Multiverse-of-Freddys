...
import net.mcreator.themultiverseoffreddys.entity.renderer.UndyingRenderer;
...
public class UndyingEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10940400, -16777216, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("undying_spawn_egg"));
	}
