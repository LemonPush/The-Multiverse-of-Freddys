...
import net.mcreator.themultiverseoffreddys.entity.renderer.FazGooBruteRenderer;
...
public class FazGooBruteEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750055, -52225, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("faz_goo_brute_spawn_egg"));
	}
