...
import net.mcreator.themultiverseoffreddys.entity.renderer.GreyPuppetRenderer;
...
public class GreyPuppetEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16580087, -11711155, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("grey_puppet_spawn_egg"));
	}
