...
import net.mcreator.themultiverseoffreddys.entity.renderer.IgnitedBonnieRenderer;
...
public class IgnitedBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -16764058, new Item.Properties().group(TJoCTabItemGroup.tab))
				.setRegistryName("ignited_bonnie_spawn_egg"));
	}
