...
import net.mcreator.themultiverseoffreddys.entity.renderer.HourglassRenderer;
...
public class HourglassEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3889023, -16777216, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("hourglass_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:deathhourglass_ti"));
		}
