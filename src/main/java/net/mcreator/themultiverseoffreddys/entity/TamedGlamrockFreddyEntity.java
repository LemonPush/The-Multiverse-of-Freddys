...
import net.mcreator.themultiverseoffreddys.procedures.TamedGlamrockFreddyRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.BatteryItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedGlamrockFreddyRenderer;
...
public class TamedGlamrockFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("tamed_glamrock_freddy").setRegistryName("tamed_glamrock_freddy");

	public TamedGlamrockFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 712);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedGlamrockFreddyRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedGlamrockFreddyRightClickedOnEntityProcedure.executeProcedure(Stream
