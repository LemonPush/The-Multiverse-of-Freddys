...
import net.mcreator.themultiverseoffreddys.procedures.PizzaMonsterEntityDiesProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.FFTabItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.PizzaMonsterRenderer;
...
public class PizzaMonsterEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8502237, -3167194, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("pizza_monster_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			PizzaMonsterEntityDiesProcedure.executeProcedure(Stream
