...
import net.mcreator.themultiverseoffreddys.entity.renderer.SaffronRenderer;
...
public class SaffronEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13032690, -13434829, new Item.Properties().group(PopgoesTabItemGroup.tab))
				.setRegistryName("saffron_spawn_egg"));
	}
