...
import net.mcreator.themultiverseoffreddys.entity.renderer.TheBreakingWheelRenderer;
...
public class TheBreakingWheelEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13695482, -12961222, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("the_breaking_wheel_spawn_egg"));
	}
