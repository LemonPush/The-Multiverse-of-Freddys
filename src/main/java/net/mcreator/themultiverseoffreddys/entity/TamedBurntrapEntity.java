...
import net.mcreator.themultiverseoffreddys.procedures.TamedBurntrapRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.BatteryItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedBurntrapRenderer;
...
public class TamedBurntrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedBurntrapRightClickedOnEntityProcedure.executeProcedure(Stream
