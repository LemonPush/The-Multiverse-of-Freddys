...
import net.mcreator.themultiverseoffreddys.entity.renderer.GoldenFlumptyRenderer;
...
public class GoldenFlumptyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -10066432, new Item.Properties().group(FlumptyTabItemGroup.tab))
				.setRegistryName("golden_flumpty_spawn_egg"));
	}
