...
import net.mcreator.themultiverseoffreddys.entity.renderer.LibertyChicaRenderer;
...
public class LibertyChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751053, -16751104, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("liberty_chica_spawn_egg"));
	}
