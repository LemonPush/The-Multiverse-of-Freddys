...
import net.mcreator.themultiverseoffreddys.entity.renderer.ElChipRenderer;
...
public class ElChipEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6737152, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("el_chip_spawn_egg"));
	}
