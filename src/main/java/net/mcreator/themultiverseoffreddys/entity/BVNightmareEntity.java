...
import net.mcreator.themultiverseoffreddys.entity.renderer.BVNightmareRenderer;
...
public class BVNightmareEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -256, -16777216, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("bv_nightmare_spawn_egg"));
	}
