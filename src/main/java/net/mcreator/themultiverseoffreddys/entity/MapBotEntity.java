...
import net.mcreator.themultiverseoffreddys.entity.renderer.MapBotRenderer;
...
public class MapBotEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -205, -10922836, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("map_bot_spawn_egg"));
	}
