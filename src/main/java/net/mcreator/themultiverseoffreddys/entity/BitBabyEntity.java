...
import net.mcreator.themultiverseoffreddys.entity.renderer.BitBabyRenderer;
...
public class BitBabyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -6750208, -1, new Item.Properties().group(ARTabItemGroup.tab)).setRegistryName("bit_baby_spawn_egg"));
	}
