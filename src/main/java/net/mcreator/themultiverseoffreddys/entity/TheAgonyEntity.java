...
import net.mcreator.themultiverseoffreddys.entity.renderer.TheAgonyRenderer;
...
public class TheAgonyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("the_agony_spawn_egg"));
	}
