...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightmareJJRenderer;
...
public class NightmareJJEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15117289, -11397522, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("nightmare_jj_spawn_egg"));
	}
