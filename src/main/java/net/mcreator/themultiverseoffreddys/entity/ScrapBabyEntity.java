...
import net.mcreator.themultiverseoffreddys.entity.renderer.ScrapBabyRenderer;
...
public class ScrapBabyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6737152, -1, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("scrap_baby_spawn_egg"));
	}
