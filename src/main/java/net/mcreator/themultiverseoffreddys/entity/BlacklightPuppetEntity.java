...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlacklightPuppetRenderer;
...
public class BlacklightPuppetEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -13421824, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("blacklight_puppet_spawn_egg"));
	}
