...
import net.mcreator.themultiverseoffreddys.entity.renderer.IgnitedPuppetRenderer;
...
public class IgnitedPuppetEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -16777216, new Item.Properties().group(TJoCTabItemGroup.tab))
				.setRegistryName("ignited_puppet_spawn_egg"));
	}
