...
import net.mcreator.themultiverseoffreddys.entity.renderer.ScraptrapRenderer;
...
public class ScraptrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12101602, -13282020, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("scraptrap_spawn_egg"));
	}
