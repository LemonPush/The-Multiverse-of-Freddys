...
import net.mcreator.themultiverseoffreddys.entity.renderer.OswaldRenderer;
...
public class OswaldEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14606047, -15786415, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("oswald_spawn_egg"));
	}
