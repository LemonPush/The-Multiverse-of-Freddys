...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomMangleRenderer;
...
public class PhantomMangleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9408400, -15788540, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("phantom_mangle_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:mangle3"));
		}
