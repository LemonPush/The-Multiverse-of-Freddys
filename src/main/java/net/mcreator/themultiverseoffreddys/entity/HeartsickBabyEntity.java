...
import net.mcreator.themultiverseoffreddys.entity.renderer.HeartsickBabyRenderer;
...
public class HeartsickBabyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -10092442, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("heartsick_baby_spawn_egg"));
	}
