...
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedFlamingSpringtrapRenderer;
...
public class TamedFlamingSpringtrapEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.7999999999999998f)).build("tamed_flaming_springtrap").setRegistryName("tamed_flaming_springtrap");

	public TamedFlamingSpringtrapEntity(UltimateFnafModModElements instance) {
		super(instance, 778);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedFlamingSpringtrapRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(FazcoinItem.block), false));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (FazcoinItem.block == stack.getItem())
				return true;
			return false;
		}
