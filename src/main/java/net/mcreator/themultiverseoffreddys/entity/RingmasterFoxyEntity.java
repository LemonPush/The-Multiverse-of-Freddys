...
import net.mcreator.themultiverseoffreddys.entity.renderer.RingmasterFoxyRenderer;
...
public class RingmasterFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434880, -13421773, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("ringmaster_foxy_spawn_egg"));
	}
