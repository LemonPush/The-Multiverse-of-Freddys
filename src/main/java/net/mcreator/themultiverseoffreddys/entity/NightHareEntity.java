...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightHareRenderer;
...
public class NightHareEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15529952, -4603371, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("night_hare_spawn_egg"));
	}
