...
import net.mcreator.themultiverseoffreddys.entity.renderer.MusicManRenderer;
...
public class MusicManEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("music_man").setRegistryName("music_man");

	public MusicManEntity(UltimateFnafModModElements instance) {
		super(instance, 609);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MusicManRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -13434829, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("music_man_spawn_egg"));
	}
