...
import net.mcreator.themultiverseoffreddys.entity.renderer.SewerBotRenderer;
...
public class SewerBotEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13477572, -11577303, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("sewer_bot_spawn_egg"));
	}
