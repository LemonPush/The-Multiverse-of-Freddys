...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomPuppetRenderer;
...
public class PhantomPuppetEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("phantom_puppet").setRegistryName("phantom_puppet");

	public PhantomPuppetEntity(UltimateFnafModModElements instance) {
		super(instance, 513);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PhantomPuppetRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764160, -16777216, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("phantom_puppet_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:puppet3"));
		}
