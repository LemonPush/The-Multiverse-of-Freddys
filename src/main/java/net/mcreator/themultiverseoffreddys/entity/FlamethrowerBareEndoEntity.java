...
import net.mcreator.themultiverseoffreddys.entity.renderer.FlamethrowerBareEndoRenderer;
...
public class FlamethrowerBareEndoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -6737152, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("flamethrower_bare_endo_spawn_egg"));
	}
