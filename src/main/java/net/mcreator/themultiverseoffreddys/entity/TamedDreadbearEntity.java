...
import net.mcreator.themultiverseoffreddys.procedures.TamedDreadbearHurtProcedure;
import net.mcreator.themultiverseoffreddys.item.CandyItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedDreadbearRenderer;
...
public class TamedDreadbearEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.6f)).build("tamed_dreadbear").setRegistryName("tamed_dreadbear");

	public TamedDreadbearEntity(UltimateFnafModModElements instance) {
		super(instance, 989);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedDreadbearRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(CandyItem.block), false));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TamedDreadbearHurtProcedure.executeProcedure(Stream
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (CandyItem.block == stack.getItem())
				return true;
			return false;
		}
	}
