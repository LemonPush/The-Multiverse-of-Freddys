...
import net.mcreator.themultiverseoffreddys.entity.renderer.CatrinaToyChicaRenderer;
...
public class CatrinaToyChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -3355444, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("catrina_toy_chica_spawn_egg"));
	}
