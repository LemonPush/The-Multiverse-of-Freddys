...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlacklightChicaRenderer;
...
public class BlacklightChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750055, -3355648, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("blacklight_chica_spawn_egg"));
	}
