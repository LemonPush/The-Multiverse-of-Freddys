...
import net.mcreator.themultiverseoffreddys.itemgroup.JollyTabItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredTweetieRenderer;
...
public class WitheredTweetieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3290488, -4218258, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("withered_tweetie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:death_j"));
		}
