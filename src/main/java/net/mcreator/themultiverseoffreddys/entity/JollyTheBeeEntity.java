...
import net.mcreator.themultiverseoffreddys.entity.renderer.JollyTheBeeRenderer;
...
public class JollyTheBeeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777165, -3355444, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("jolly_the_bee_spawn_egg"));
	}
