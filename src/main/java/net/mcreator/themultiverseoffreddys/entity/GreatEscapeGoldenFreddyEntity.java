...
import net.mcreator.themultiverseoffreddys.entity.renderer.GreatEscapeGoldenFreddyRenderer;
...
public class GreatEscapeGoldenFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12049408, -3355648, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("great_escape_golden_freddy_spawn_egg"));
	}
