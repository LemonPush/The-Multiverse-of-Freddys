...
import net.mcreator.themultiverseoffreddys.procedures.TamedPhoneGuyRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.CakeSliceItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedPhoneGuyRenderer;
...
public class TamedPhoneGuyEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedPhoneGuyRightClickedOnEntityProcedure.executeProcedure(Stream
