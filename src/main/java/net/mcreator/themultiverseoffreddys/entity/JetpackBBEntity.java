...
import net.mcreator.themultiverseoffreddys.entity.renderer.JetpackBBRenderer;
...
public class JetpackBBEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -13159, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("jetpack_bb_spawn_egg"));
	}
