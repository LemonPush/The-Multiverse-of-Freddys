...
import net.mcreator.themultiverseoffreddys.entity.renderer.TFCCircusBabyRenderer;
...
public class TFCCircusBabyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3205610, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("tfc_circus_baby_spawn_egg"));
	}
