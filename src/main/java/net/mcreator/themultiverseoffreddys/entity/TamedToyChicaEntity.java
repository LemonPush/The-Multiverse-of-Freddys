...
import net.mcreator.themultiverseoffreddys.procedures.TamedToyChicaRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.SodaItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedToyChicaRenderer;
...
public class TamedToyChicaEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("tamed_toy_chica").setRegistryName("tamed_toy_chica");

	public TamedToyChicaEntity(UltimateFnafModModElements instance) {
		super(instance, 943);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedToyChicaRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(SodaItem.block), false));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedToyChicaRightClickedOnEntityProcedure.executeProcedure(Stream
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (SodaItem.block == stack.getItem())
				return true;
			return false;
		}
	}
