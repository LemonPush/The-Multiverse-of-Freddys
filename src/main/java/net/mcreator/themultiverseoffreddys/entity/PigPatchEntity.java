...
import net.mcreator.themultiverseoffreddys.entity.renderer.PigPatchRenderer;
...
public class PigPatchEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -26113, -39169, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("pig_patch_spawn_egg"));
	}
