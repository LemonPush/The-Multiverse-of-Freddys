...
import net.mcreator.themultiverseoffreddys.entity.renderer.NightmarionneBotRenderer;
...
public class NightmarionneBotEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4276546, -10790295, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("nightmarionne_bot_spawn_egg"));
	}
