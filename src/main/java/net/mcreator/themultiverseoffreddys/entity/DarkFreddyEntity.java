...
import net.mcreator.themultiverseoffreddys.entity.renderer.DarkFreddyRenderer;
...
public class DarkFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("dark_freddy_spawn_egg"));
	}
