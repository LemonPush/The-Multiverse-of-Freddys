...
import net.mcreator.themultiverseoffreddys.entity.renderer.MendoRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class MendoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -13434625, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("mendo_spawn_egg"));
	}
