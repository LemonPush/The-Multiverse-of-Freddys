...
import net.mcreator.themultiverseoffreddys.procedures.FlipsideLootProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.F3ItemGroup;
import net.mcreator.themultiverseoffreddys.item.SodaItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.BlacklightMangleRenderer;
...
public class BlacklightMangleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9737365, -13395712, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("blacklight_mangle_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:mangle2"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			FlipsideLootProcedure.executeProcedure(Stream
