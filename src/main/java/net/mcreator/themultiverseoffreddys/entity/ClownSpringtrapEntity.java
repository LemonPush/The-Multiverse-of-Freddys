...
import net.mcreator.themultiverseoffreddys.entity.renderer.ClownSpringtrapRenderer;
...
public class ClownSpringtrapEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clown_springtrap").setRegistryName("clown_springtrap");

	public ClownSpringtrapEntity(UltimateFnafModModElements instance) {
		super(instance, 782);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ClownSpringtrapRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -13434880, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("clown_springtrap_spawn_egg"));
	}
