...
import net.mcreator.themultiverseoffreddys.procedures.FazGooLootProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.FFTabItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.HeToldMeEverythingRenderer;
...
public class HeToldMeEverythingEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -52225, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("he_told_me_everything_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			FazGooLootProcedure.executeProcedure(Stream
