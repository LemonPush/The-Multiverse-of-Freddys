...
import net.mcreator.themultiverseoffreddys.entity.renderer.TogetherForeverRenderer;
...
public class TogetherForeverEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750055, -52276, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("together_forever_spawn_egg"));
	}
