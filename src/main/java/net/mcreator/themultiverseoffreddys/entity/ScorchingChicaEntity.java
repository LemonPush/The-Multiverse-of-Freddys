...
import net.mcreator.themultiverseoffreddys.entity.renderer.ScorchingChicaRenderer;
...
public class ScorchingChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -10092544, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("scorching_chica_spawn_egg"));
	}
