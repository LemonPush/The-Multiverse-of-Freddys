...
import net.mcreator.themultiverseoffreddys.entity.renderer.EllaDollRenderer;
...
public class EllaDollEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764007, -16737895, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("ella_doll_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(EllaBlock.block));
		}
