...
import net.mcreator.themultiverseoffreddys.entity.renderer.ElectrobabRenderer;
...
public class ElectrobabEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15919787, -13809780, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("electrobab_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:deathshort5"));
		}
