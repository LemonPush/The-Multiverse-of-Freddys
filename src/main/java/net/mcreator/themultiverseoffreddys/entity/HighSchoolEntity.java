...
import net.mcreator.themultiverseoffreddys.entity.renderer.HighSchoolRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class HighSchoolEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1520340, -1489396, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("high_school_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.fromItems(SodaItem.block), false));
