...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredFoxyRenderer;
...
public class WitheredFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8442833, -9107191, new Item.Properties().group(FNaF2TabItemGroup.tab))
