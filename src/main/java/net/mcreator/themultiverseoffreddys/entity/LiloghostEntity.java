...
import net.mcreator.themultiverseoffreddys.procedures.LiloghostOnInitialEntitySpawnProcedure;
import net.mcreator.themultiverseoffreddys.procedures.LiloghostEntityIsHurtProcedure;
import net.mcreator.themultiverseoffreddys.item.LiloghostShootItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.LiloghostRenderer;
...
public class LiloghostEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			LiloghostEntityIsHurtProcedure.executeProcedure(Stream
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			LiloghostOnInitialEntitySpawnProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			return retval;
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			LiloghostShootItem.shoot(this, target);
		}
