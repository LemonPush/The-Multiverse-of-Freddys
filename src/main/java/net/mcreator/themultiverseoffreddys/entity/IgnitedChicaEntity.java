...
import net.mcreator.themultiverseoffreddys.entity.renderer.IgnitedChicaRenderer;
...
public class IgnitedChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066432, -13421824, new Item.Properties().group(TJoCTabItemGroup.tab))
				.setRegistryName("ignited_chica_spawn_egg"));
	}
