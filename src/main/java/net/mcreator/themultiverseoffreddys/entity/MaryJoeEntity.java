...
import net.mcreator.themultiverseoffreddys.entity.renderer.MaryJoeRenderer;
...
public class MaryJoeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -13434829, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("mary_joe_spawn_egg"));
	}
