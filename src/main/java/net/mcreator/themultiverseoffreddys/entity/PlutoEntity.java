...
import net.mcreator.themultiverseoffreddys.entity.renderer.PlutoRenderer;
...
public class PlutoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8687095, -9079001, new Item.Properties().group(TreasureTabItemGroup.tab))
