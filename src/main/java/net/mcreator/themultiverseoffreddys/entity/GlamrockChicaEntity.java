...
import net.mcreator.themultiverseoffreddys.entity.renderer.GlamrockChicaRenderer;
...
public class GlamrockChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3407668, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("glamrock_chica_spawn_egg"));
	}
