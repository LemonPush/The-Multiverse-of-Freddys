...
import net.mcreator.themultiverseoffreddys.entity.renderer.NoSuitRenderer;
...
public class NoSuitEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434880, -13421773, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("no_suit_spawn_egg"));
	}
