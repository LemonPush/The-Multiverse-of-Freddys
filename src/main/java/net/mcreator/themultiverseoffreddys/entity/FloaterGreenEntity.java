...
import net.mcreator.themultiverseoffreddys.entity.renderer.FloaterGreenRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class FloaterGreenEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13395712, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("floater_green_spawn_egg"));
	}
