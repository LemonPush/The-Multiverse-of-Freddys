...
import net.mcreator.themultiverseoffreddys.entity.renderer.BalloonRenderer;
...
public class BalloonEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6750208, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("balloon_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PartyHatItem.block));
		}
