...
import net.mcreator.themultiverseoffreddys.entity.renderer.SanstrapRenderer;
...
public class SanstrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724992, -16776961, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("sanstrap_spawn_egg"));
	}
