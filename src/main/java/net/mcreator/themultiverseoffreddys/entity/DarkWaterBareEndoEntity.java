...
import net.mcreator.themultiverseoffreddys.entity.renderer.DarkWaterBareEndoRenderer;
...
public class DarkWaterBareEndoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -16750900, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("dark_water_bare_endo_spawn_egg"));
	}
