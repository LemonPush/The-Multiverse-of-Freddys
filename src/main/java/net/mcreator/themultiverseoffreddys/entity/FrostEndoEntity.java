...
import net.mcreator.themultiverseoffreddys.entity.renderer.FrostEndoRenderer;
...
public class FrostEndoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751002, -16764109, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("frost_endo_spawn_egg"));
	}
