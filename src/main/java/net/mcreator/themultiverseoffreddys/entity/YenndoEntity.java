...
import net.mcreator.themultiverseoffreddys.entity.renderer.YenndoRenderer;
...
public class YenndoEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6776680, -7895161, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("yenndo_spawn_egg"));
	}
