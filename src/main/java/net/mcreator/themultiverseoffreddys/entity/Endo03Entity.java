...
import net.mcreator.themultiverseoffreddys.entity.renderer.Endo03Renderer;
...
public class Endo03Entity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("endo_03").setRegistryName("endo_03");

	public Endo03Entity(UltimateFnafModModElements instance) {
		super(instance, 516);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endo03Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -13421773, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("endo_03_spawn_egg"));
	}
