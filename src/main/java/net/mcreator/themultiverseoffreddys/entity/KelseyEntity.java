...
import net.mcreator.themultiverseoffreddys.entity.renderer.KelseyRenderer;
...
public class KelseyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777063, -16750951, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("kelsey_spawn_egg"));
	}
