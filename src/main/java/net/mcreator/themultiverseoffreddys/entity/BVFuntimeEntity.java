...
import net.mcreator.themultiverseoffreddys.entity.renderer.BVFuntimeRenderer;
...
public class BVFuntimeEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -16777216, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("bv_funtime_spawn_egg"));
	}
