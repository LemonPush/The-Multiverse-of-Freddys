...
import net.mcreator.themultiverseoffreddys.entity.renderer.FrostPlushtrapRenderer;
...
public class FrostPlushtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6684673, -13369345, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("frost_plushtrap_spawn_egg"));
	}
