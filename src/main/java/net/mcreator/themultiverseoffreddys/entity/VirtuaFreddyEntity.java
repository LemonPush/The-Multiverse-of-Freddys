...
import net.mcreator.themultiverseoffreddys.entity.renderer.VirtuaFreddyRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class VirtuaFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13369600, -16724941, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("virtua_freddy_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(PezDispenserItem.block), false));
