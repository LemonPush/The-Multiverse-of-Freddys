...
import net.mcreator.themultiverseoffreddys.entity.renderer.ImpurityRenderer;
...
public class ImpurityEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -11464945, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("impurity_spawn_egg"));
	}
