...
import net.mcreator.themultiverseoffreddys.entity.renderer.AeronautToyFreddyRenderer;
...
public class AeronautToyFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6737152, -11263744, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("aeronaut_toy_freddy_spawn_egg"));
	}
