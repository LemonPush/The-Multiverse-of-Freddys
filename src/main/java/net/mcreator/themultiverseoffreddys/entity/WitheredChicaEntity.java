...
import net.mcreator.themultiverseoffreddys.entity.renderer.WitheredChicaRenderer;
...
public class WitheredChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -5465058, -6341357, new Item.Properties().group(FNaF2TabItemGroup.tab))
