...
import net.mcreator.themultiverseoffreddys.entity.renderer.ArcticBalloraRenderer;
...
public class ArcticBalloraEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10040065, -10066177, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("arctic_ballora_spawn_egg"));
	}
