...
import net.mcreator.themultiverseoffreddys.entity.renderer.FrostbiteBalloonBoyRenderer;
...
public class FrostbiteBalloonBoyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -13369345, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("frostbite_balloon_boy_spawn_egg"));
	}
