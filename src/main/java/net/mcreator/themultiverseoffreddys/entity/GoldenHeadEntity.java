...
import net.mcreator.themultiverseoffreddys.entity.renderer.GoldenHeadRenderer;
...
public class GoldenHeadEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3169280, -9546737, new Item.Properties().group(FNaF2TabItemGroup.tab))
				.setRegistryName("golden_head_spawn_egg"));
	}
