...
import net.mcreator.themultiverseoffreddys.entity.renderer.ScottCawthonRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class ScottCawthonEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -6684673, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("scott_cawthon_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.fromItems(CakeSliceItem.block), false));
