...
import net.mcreator.themultiverseoffreddys.procedures.TamedCircusBabyHurtProcedure;
import net.mcreator.themultiverseoffreddys.item.RemnantItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedCircusBabyRenderer;
...
public class TamedCircusBabyEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TamedCircusBabyHurtProcedure.executeProcedure(Stream
