...
import net.mcreator.themultiverseoffreddys.procedures.TamedNightmareFredbearRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.IllusionDiscItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedNightmareFredbearRenderer;
...
public class TamedNightmareFredbearEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedNightmareFredbearRightClickedOnEntityProcedure.executeProcedure(Stream
