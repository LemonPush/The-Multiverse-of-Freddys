...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShamrockFreddyRenderer;
...
public class ShamrockFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16738048, -16751104, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("shamrock_freddy_spawn_egg"));
	}
