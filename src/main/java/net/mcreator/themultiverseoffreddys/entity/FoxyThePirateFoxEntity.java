...
import net.mcreator.themultiverseoffreddys.entity.renderer.FoxyThePirateFoxRenderer;
...
public class FoxyThePirateFoxEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -5498599, -6865860, new Item.Properties().group(FNaF1TabItemGroup.tab))
				.setRegistryName("foxy_the_pirate_fox_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:foxy1"));
		}

		@Override
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:walkfoxy1")),
					0.15f, 1);
		}
