...
import net.mcreator.themultiverseoffreddys.entity.renderer.DystopianMichaelRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class DystopianMichaelEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16318413, new Item.Properties().group(F4ItemGroup.tab))
				.setRegistryName("dystopian_michael_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.fromItems(PizzaItem.block), false));
