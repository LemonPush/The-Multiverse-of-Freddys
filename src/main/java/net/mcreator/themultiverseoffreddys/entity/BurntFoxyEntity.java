...
import net.mcreator.themultiverseoffreddys.entity.renderer.BurntFoxyRenderer;
...
public class BurntFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15399161, -14350071, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("burnt_foxy_spawn_egg"));
	}
