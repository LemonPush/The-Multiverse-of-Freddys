...
import net.mcreator.themultiverseoffreddys.entity.renderer.GraveweedRenderer;
...
public class GraveweedEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -13421773, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("graveweed_spawn_egg"));
	}
