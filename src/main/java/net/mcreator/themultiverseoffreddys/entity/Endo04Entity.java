...
import net.mcreator.themultiverseoffreddys.entity.renderer.Endo04Renderer;
...
public class Endo04Entity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -10066330, new Item.Properties().group(FNaF4TabItemGroup.tab))
				.setRegistryName("endo_04_spawn_egg"));
	}
