...
import net.mcreator.themultiverseoffreddys.procedures.TamedHelpyRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.PartyHatItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedHelpyRenderer;
...
public class TamedHelpyEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedHelpyRightClickedOnEntityProcedure.executeProcedure(Stream
