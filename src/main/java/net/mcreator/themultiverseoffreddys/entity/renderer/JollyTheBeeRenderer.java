...
@OnlyIn(Dist.CLIENT)
public class JollyTheBeeRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(JollyTheBeeEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelJolly_the_Bee(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/jolly_the_bee.png");
					}
				};
			});
		}
