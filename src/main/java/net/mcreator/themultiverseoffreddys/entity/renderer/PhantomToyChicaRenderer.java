...
import net.mcreator.themultiverseoffreddys.entity.PhantomToyChicaEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class PhantomToyChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PhantomToyChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPhantomToyChica(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/phantomtoychica.png");
					}
				};
			});
		}
	...
	public static class ModelPhantomToyChica extends EntityModel<Entity> {
		...
		public ModelPhantomToyChica() {
			textureWidth = 128;
			textureHeight = 128;
			head = new ModelRenderer(this);
			head.setRotationPoint(0.0F, -2.0F, 0.0F);
			head.setTextureOffset(0, 0).addBox(-4.0F, -14.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.25F, false);
			head.setTextureOffset(46, 63).addBox(2.9F, -9.5F, -4.7F, 2.0F, 2.0F, 1.0F, -0.25F, false);
			...
			head_r6.setTextureOffset(18, 63).addBox(0.5F, -1.8F, 1.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);
			...
			body.setTextureOffset(24, 63).addBox(-6.0F, -5.0F, -0.8F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(62, 61).addBox(5.0F, -5.0F, -0.8F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			...
			right_leg.setTextureOffset(32, 50).addBox(-1.9F, 8.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.1F, false);
			right_leg.setTextureOffset(50, 4).addBox(-1.9F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.25F, false);
			right_leg.setTextureOffset(59, 43).addBox(-0.9F, 7.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			right_leg.setTextureOffset(59, 34).addBox(-0.9F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			right_leg.setTextureOffset(63, 46).addBox(-0.4F, 15.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.1F, false);
			right_leg.setTextureOffset(64, 58).addBox(-2.4F, 15.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.1F, false);
			right_leg.setTextureOffset(64, 23).addBox(1.6F, 15.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.1F, false);
			...
			left_leg.setTextureOffset(47, 44).addBox(-2.1F, 8.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.1F, false);
			left_leg.setTextureOffset(16, 45).addBox(-2.1F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.25F, false);
			left_leg.setTextureOffset(55, 19).addBox(-1.1F, 7.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			left_leg.setTextureOffset(12, 55).addBox(-1.1F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			left_leg.setTextureOffset(35, 29).addBox(-2.6F, 14.0F, -4.0F, 5.0F, 2.0F, 7.0F, 0.1F, false);
			left_leg.setTextureOffset(65, 33).addBox(-2.6F, 15.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.1F, false);
			left_leg.setTextureOffset(28, 65).addBox(1.4F, 15.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.1F, false);
			left_leg.setTextureOffset(63, 49).addBox(-0.6F, 15.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.1F, false);
			left_arm = new ModelRenderer(this);
			left_arm.setRotationPoint(-5.0F, -5.0F, 0.0F);
			left_arm.setTextureOffset(35, 38).addBox(-5.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
			left_arm.setTextureOffset(52, 24).addBox(-5.0F, 5.0F, -2.0F, 4.0F, 5.0F, 4.0F, 0.0F, false);
			...
			right_arm.setTextureOffset(52, 24).addBox(1.0F, 5.0F, -2.0F, 4.0F, 5.0F, 4.0F, 0.0F, true);
			right_arm.setTextureOffset(0, 31).addBox(2.0F, 10.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, true);
			right_arm.setTextureOffset(0, 28).addBox(2.0F, 4.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, true);
			right_arm.setTextureOffset(0, 55).addBox(1.0F, 11.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, true);
		}
