...
@OnlyIn(Dist.CLIENT)
public class MendoRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MendoEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMendo(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/mendo.png");
					}
				};
			});
		}
