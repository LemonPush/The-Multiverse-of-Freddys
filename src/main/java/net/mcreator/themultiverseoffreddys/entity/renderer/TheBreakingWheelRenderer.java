...
@OnlyIn(Dist.CLIENT)
public class TheBreakingWheelRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TheBreakingWheelEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelJulius(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/julius.png");
					}
				};
			});
		}
