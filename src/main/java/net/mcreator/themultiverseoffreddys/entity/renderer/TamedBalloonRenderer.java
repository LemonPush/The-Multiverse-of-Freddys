...
@OnlyIn(Dist.CLIENT)
public class TamedBalloonRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedBalloonEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBalloon(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/balloon.png");
					}
				};
			});
		}
