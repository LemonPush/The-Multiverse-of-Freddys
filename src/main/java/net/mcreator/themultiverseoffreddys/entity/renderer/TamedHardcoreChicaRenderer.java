...
@OnlyIn(Dist.CLIENT)
public class TamedHardcoreChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedHardcoreChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelChica_the_Chicken(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/neon_chica.png");
					}
				};
			});
		}
	...
	public static class ModelChica_the_Chicken extends EntityModel<Entity> {
		...
		public ModelChica_the_Chicken() {
			textureWidth = 128;
			textureHeight = 128;
			head = new ModelRenderer(this);
			head.setRotationPoint(0.0F, -7.9532F, 0.0645F);
			head.setTextureOffset(0, 0).addBox(-4.0F, -8.0468F, -4.0645F, 8.0F, 8.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(49, 0).addBox(-3.0F, -1.0468F, -7.0645F, 6.0F, 1.0F, 4.0F, 0.0F, false);
			head.setTextureOffset(49, 25).addBox(-3.0F, -2.0468F, -7.0645F, 6.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(0, 36).addBox(-3.0F, -2.0468F, -6.0645F, 1.0F, 1.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(32, 27).addBox(2.0F, -2.0468F, -6.0645F, 1.0F, 1.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(57, 58).addBox(-2.0F, -4.0468F, -6.8645F, 4.0F, 1.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(48, 18).addBox(-3.0F, -3.5468F, -7.2645F, 6.0F, 1.0F, 4.0F, 0.0F, false);
			head.setTextureOffset(40, 8).addBox(-1.0F, -4.5468F, -6.5645F, 2.0F, 1.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(64, 12).addBox(-2.7F, -6.5468F, -4.5645F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(54, 5).addBox(0.7F, -6.5468F, -4.5645F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(0, 51).addBox(0.7F, -7.5468F, -4.5645F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(18, 41).addBox(-2.7F, -7.5468F, -4.5645F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(30, 8).addBox(-4.5F, -7.5468F, -4.0645F, 1.0F, 7.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(22, 24).addBox(3.5F, -7.5468F, -4.0645F, 1.0F, 7.0F, 8.0F, 0.0F, false);
			head_r1 = new ModelRenderer(this);
			head_r1.setRotationPoint(0.0F, -9.5468F, -1.5645F);
			...
			head_r2.setRotationPoint(0.0F, -9.5468F, -1.5645F);
			...
			head_r3.setRotationPoint(0.0F, -9.5468F, -1.5645F);
			...
			head_r4.setRotationPoint(0.0F, -9.5468F, -1.5645F);
			...
			right_arm_r1.setRotationPoint(13.0F, 10.3333F, 0.0F);
			right_arm.addChild(right_arm_r1);
			setRotationAngle(right_arm_r1, -1.5708F, 0.0F, 0.0F);
			right_arm_r1.setTextureOffset(24, 48).addBox(-18.15F, 10.2667F, -12.8F, 2.0F, 1.0F, 2.0F, -0.25F, true);
			right_arm_r1.setTextureOffset(24, 48).addBox(-15.85F, 10.2667F, -12.8F, 2.0F, 1.0F, 2.0F, -0.25F, false);
			right_arm_r1.setTextureOffset(56, 49).addBox(-18.0F, 6.6667F, -13.0F, 4.0F, 4.0F, 3.0F, 0.25F, false);
			right_arm_r1.setTextureOffset(0, 0).addBox(-16.5F, 8.1667F, -16.0F, 1.0F, 1.0F, 3.0F, 0.0F, false);
			right_arm_r1.setTextureOffset(30, 58).addBox(-18.0F, 6.6667F, -10.0F, 4.0F, 4.0F, 2.0F, 0.0F, false);
			right_arm_r1.setTextureOffset(16, 58).addBox(-19.0F, 5.6667F, -8.0F, 6.0F, 6.0F, 1.0F, 0.0F, false);
			right_arm_r1.setTextureOffset(54, 28).addBox(-18.0F, 6.6667F, -7.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
			right_arm_r1.setTextureOffset(49, 27).addBox(-17.0F, 5.6667F, -6.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			right_arm_r1.setTextureOffset(44, 52).addBox(-18.0F, 0.6667F, -7.0F, 4.0F, 5.0F, 4.0F, 0.0F, false);
