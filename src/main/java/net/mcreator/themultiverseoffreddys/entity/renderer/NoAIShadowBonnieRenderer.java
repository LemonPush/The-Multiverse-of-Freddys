...
import net.mcreator.themultiverseoffreddys.entity.NoAIShadowBonnieEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class NoAIShadowBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NoAIShadowBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelShadowBonnie(), 0.5f) {
					{
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/shadowbonnie.png");
					}
				};
			});
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn
					.getBuffer(RenderType.getEyes(new ResourceLocation("ultimate_fnaf_mod:textures/entities/shadowbonnie_glow.png")));
	...
	public static class ModelShadowBonnie extends EntityModel<Entity> {
		...
		public ModelShadowBonnie() {
			...
			head_r4.setTextureOffset(0, 60).addBox(-1.5F, -8.2677F, 1.6361F, 3.0F, 3.0F, 2.0F, 0.25F, false);
