...
import net.mcreator.themultiverseoffreddys.entity.ClockworkBalloraEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ClockworkBalloraRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ClockworkBalloraEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelClockwork_Ballora(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/clockwork_ballora.png");
					}
				};
			});
		}
