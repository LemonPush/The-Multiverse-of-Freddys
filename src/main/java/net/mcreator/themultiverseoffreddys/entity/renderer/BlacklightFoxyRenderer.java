...
import net.mcreator.themultiverseoffreddys.entity.BlacklightFoxyEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class BlacklightFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BlacklightFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFoxy_the_Pirate_Fox(), 0.4f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/blacklightfoxy.png");
					}
				};
			});
		}
	...
	public static class ModelFoxy_the_Pirate_Fox extends EntityModel<Entity> {
		...
		public ModelFoxy_the_Pirate_Fox() {
			textureWidth = 128;
			textureHeight = 128;
			...
			head.setTextureOffset(62, 33).addBox(-2.7F, -12.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(0, 6).addBox(-2.7F, -13.5F, -4.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
