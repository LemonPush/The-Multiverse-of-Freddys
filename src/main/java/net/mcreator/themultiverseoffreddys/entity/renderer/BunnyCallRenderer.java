...
@OnlyIn(Dist.CLIENT)
public class BunnyCallRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BunnyCallEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBunnyCall(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/bunnycall.png");
					}
				};
			});
		}
