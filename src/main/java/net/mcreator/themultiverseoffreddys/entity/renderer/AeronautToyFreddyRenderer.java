...
import net.mcreator.themultiverseoffreddys.entity.AeronautToyFreddyEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class AeronautToyFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AeronautToyFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelAeronaut_Toy_Freddy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/aeronaut_toy_freddy.png");
					}
				};
			});
		}
