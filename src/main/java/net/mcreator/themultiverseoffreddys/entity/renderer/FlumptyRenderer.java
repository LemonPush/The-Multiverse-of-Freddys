...
@OnlyIn(Dist.CLIENT)
public class FlumptyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FlumptyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFlmupty(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/flmupty.png");
					}
				};
			});
		}
