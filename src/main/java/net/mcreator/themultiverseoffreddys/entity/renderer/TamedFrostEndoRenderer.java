...
@OnlyIn(Dist.CLIENT)
public class TamedFrostEndoRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedFrostEndoEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFrozenGlamrockEndo(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/frozenglamrockendo.png");
					}
				};
			});
		}
	...
	public static class ModelFrozenGlamrockEndo extends EntityModel<Entity> {
		...
		public ModelFrozenGlamrockEndo() {
			textureWidth = 64;
			textureHeight = 64;
