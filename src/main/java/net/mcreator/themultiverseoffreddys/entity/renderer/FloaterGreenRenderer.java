...
@OnlyIn(Dist.CLIENT)
public class FloaterGreenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FloaterGreenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFloater(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/floater_green.png");
					}
				};
			});
		}
