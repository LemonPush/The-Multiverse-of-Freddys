...
@OnlyIn(Dist.CLIENT)
public class CandysRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CandysEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelCandy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/candy.png");
					}
				};
			});
		}
	...
	public static class ModelCandy extends EntityModel<Entity> {
		...
		public ModelCandy() {
			...
			head.setTextureOffset(28, 32).addBox(-3.0F, -1.4535F, -5.8269F, 6.0F, 1.0F, 3.0F, 0.0F, false);
			...
			head.setTextureOffset(53, 15).addBox(-2.5F, -4.9535F, -5.5269F, 5.0F, 1.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(0, 19).addBox(-0.5F, -5.9535F, -5.5269F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(10, 42).addBox(3.0F, -4.4535F, -4.5269F, 2.0F, 2.0F, 1.0F, -0.25F, false);
			head.setTextureOffset(54, 4).addBox(-2.7F, -6.9535F, -4.5269F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(38, 48).addBox(0.7F, -6.9535F, -4.5269F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			...
			body.setTextureOffset(10, 37).addBox(-3.5F, 4.0F, -3.5F, 7.0F, 1.0F, 1.0F, 0.0F, false);
