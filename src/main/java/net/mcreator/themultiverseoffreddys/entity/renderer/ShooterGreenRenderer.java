...
@OnlyIn(Dist.CLIENT)
public class ShooterGreenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ShooterGreenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelShooter(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/shooter_green.png");
					}
				};
			});
		}
