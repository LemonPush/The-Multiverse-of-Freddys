...
@OnlyIn(Dist.CLIENT)
public class IgnitedChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IgnitedChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIgnitedChica(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/ignitedchica.png");
					}
				};
			});
		}
