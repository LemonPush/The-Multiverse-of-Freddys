...
@OnlyIn(Dist.CLIENT)
public class VinnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(VinnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelVinnie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/vinnie.png");
					}
				};
			});
		}
