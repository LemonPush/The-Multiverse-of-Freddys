...
@OnlyIn(Dist.CLIENT)
public class PhoneDudeRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PhoneDudeEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPhoneGuy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/phonedude.png");
					}
				};
			});
		}
