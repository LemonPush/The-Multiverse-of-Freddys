...
@OnlyIn(Dist.CLIENT)
public class RWQFSFASXCRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RWQFSFASXCEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRWQFSFASXC(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/rwqfsfasxc.png");
					}
				};
			});
		}
