...
@OnlyIn(Dist.CLIENT)
public class TogetherForeverRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TogetherForeverEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRosie_Porkchop(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/rosie_porkchop.png");
					}
				};
			});
		}
