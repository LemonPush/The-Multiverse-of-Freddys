...
@OnlyIn(Dist.CLIENT)
public class TamedHighscoreToyChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedHighscoreToyChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHighscore_Toy_Chica(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/highscore_toy_chica.png");
					}
				};
			});
		}
