...
@OnlyIn(Dist.CLIENT)
public class TamedSystemErrorToyBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedSystemErrorToyBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSystem_Error_Toy_Bonnie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/system_error_toy_bonnie.png");
					}
				};
			});
		}
