...
@OnlyIn(Dist.CLIENT)
public class ImpurityRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ImpurityEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelImpurity(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/impurity.png");
					}
				};
			});
		}
