...
public class MotherRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MotherEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMother(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/mother.png");
					}
				};
			});
		}
	...
	public static class ModelMother extends EntityModel<Entity> {
