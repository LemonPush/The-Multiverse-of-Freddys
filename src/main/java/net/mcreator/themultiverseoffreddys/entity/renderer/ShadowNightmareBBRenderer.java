...
import net.mcreator.themultiverseoffreddys.entity.ShadowNightmareBBEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ShadowNightmareBBRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ShadowNightmareBBEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBalloonBoy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/shadow_nightmare_balloonboy.png");
					}
				};
			});
		}
