...
@OnlyIn(Dist.CLIENT)
public class SerpentMangleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SerpentMangleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSerpent_Mangle(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/serpent_mangle.png");
					}
				};
			});
		}
