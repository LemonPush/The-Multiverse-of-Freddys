...
@OnlyIn(Dist.CLIENT)
public class OriginsPuppetRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(OriginsPuppetEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPuppet(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/originspuppet.png");
					}
				};
			});
		}
