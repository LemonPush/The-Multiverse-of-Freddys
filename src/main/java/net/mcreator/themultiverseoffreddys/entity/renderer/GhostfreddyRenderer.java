...
@OnlyIn(Dist.CLIENT)
public class GhostfreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GhostfreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelGhost_Freddy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/ghost_freddy.png");
					}
				};
			});
		}
