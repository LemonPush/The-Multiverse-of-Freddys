...
import net.mcreator.themultiverseoffreddys.entity.DevilFreddyEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class DevilFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DevilFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDevilFreddy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/devilfreddy.png");
					}
				};
			});
		}
	...
	public static class ModelDevilFreddy extends EntityModel<Entity> {
		...
		public ModelDevilFreddy() {
			...
			head.setTextureOffset(62, 57).addBox(-2.8F, -12.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(34, 34).addBox(-2.8F, -13.5F, -4.2F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			head_r1.setTextureOffset(0, 36).addBox(0.0F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			...
			head_r2.setTextureOffset(18, 36).addBox(-1.0F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head_r3 = new ModelRenderer(this);
			head_r3.setRotationPoint(2.2F, -13.6249F, -2.9408F);
			head.addChild(head_r3);
			setRotationAngle(head_r3, 0.0F, -0.6981F, 0.0F);
			head_r3.setTextureOffset(0, 16).addBox(-0.5F, -4.6751F, -1.9092F, 1.0F, 3.0F, 1.0F, 0.0F, true);
			head_r4 = new ModelRenderer(this);
			head_r4.setRotationPoint(2.2F, -13.6249F, -2.9408F);
			head.addChild(head_r4);
			setRotationAngle(head_r4, 0.6545F, -0.6981F, 0.0F);
			head_r4.setTextureOffset(24, 0).addBox(-0.5F, -2.5141F, -0.4665F, 1.0F, 3.0F, 1.0F, 0.0F, true);
			head_r5 = new ModelRenderer(this);
			head_r5.setRotationPoint(-2.2F, -13.6249F, -2.9408F);
			head.addChild(head_r5);
			setRotationAngle(head_r5, 0.0F, 0.6981F, 0.0F);
			head_r5.setTextureOffset(0, 16).addBox(-0.5F, -4.6751F, -1.9092F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head_r6 = new ModelRenderer(this);
			head_r6.setRotationPoint(-2.2F, -13.6249F, -2.9408F);
			head.addChild(head_r6);
			setRotationAngle(head_r6, 0.6545F, 0.6981F, 0.0F);
			head_r6.setTextureOffset(24, 0).addBox(-0.5F, -2.5141F, -0.4665F, 1.0F, 3.0F, 1.0F, 0.0F, false);
