...
import net.mcreator.themultiverseoffreddys.entity.BoulderToyBonnieEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class BoulderToyBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BoulderToyBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBoulder_Toy_Bonnie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/boulder_toy_bonnie.png");
					}
				};
			});
		}
	...
	public static class ModelBoulder_Toy_Bonnie extends EntityModel<Entity> {
		...
		public ModelBoulder_Toy_Bonnie() {
			textureWidth = 128;
			textureHeight = 128;
			...
			head.setTextureOffset(0, 37).addBox(-0.5F, -11.5F, -5.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(62, 48).addBox(3.5F, -9.0F, -4.5F, 2.0F, 2.0F, 1.0F, -0.25F, false);
			head.setTextureOffset(62, 15).addBox(-5.5F, -9.0F, -4.5F, 2.0F, 2.0F, 1.0F, -0.25F, false);
			head.setTextureOffset(0, 63).addBox(-2.7F, -12.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(61, 12).addBox(0.7F, -12.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(0, 33).addBox(0.7F, -13.7F, -4.2F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(0, 33).addBox(-2.7F, -13.7F, -4.2F, 2.0F, 1.0F, 1.0F, 0.0F, true);
			...
			head_r4.setTextureOffset(18, 27).addBox(-1.5F, -8.2677F, 1.6361F, 1.0F, 3.0F, 2.0F, 0.25F, false);
			...
			body.setTextureOffset(62, 55).addBox(-1.0F, -5.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(61, 8).addBox(1.0F, -6.0F, -4.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);
			...
			body.setTextureOffset(60, 52).addBox(-1.0F, 5.0F, -0.8F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(32, 60).addBox(-1.0F, -7.0F, -0.8F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			...
			left_arm.setTextureOffset(8, 60).addBox(2.0F, 10.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			left_arm.setTextureOffset(0, 60).addBox(2.0F, 4.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			...
			left_leg.setTextureOffset(18, 32).addBox(-1.1F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
