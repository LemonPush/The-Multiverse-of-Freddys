...
@OnlyIn(Dist.CLIENT)
public class TamedRadioactiveFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedRadioactiveFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRadioactive_Foxy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/radioactive_foxy.png");
					}
				};
			});
		}
