...
@OnlyIn(Dist.CLIENT)
public class StuffedSuitRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(StuffedSuitEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelStuffed_Suit(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/stuffed_suit.png");
					}
				};
			});
		}
