...
@OnlyIn(Dist.CLIENT)
public class EyesaurRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EyesaurEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelEyesaur(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/eyesaur.png");
					}
				};
			});
		}
