...
import net.mcreator.themultiverseoffreddys.entity.PeacefulLiloghostEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class PeacefulLiloghostRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PeacefulLiloghostEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelEleanor_Peaceful(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/eleanor_peaceful.png");
					}
				};
			});
		}
