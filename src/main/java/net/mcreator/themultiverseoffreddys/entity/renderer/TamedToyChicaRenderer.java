...
@OnlyIn(Dist.CLIENT)
public class TamedToyChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedToyChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelToy_Chica(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/toy_chica.png");
					}
				};
			});
		}
