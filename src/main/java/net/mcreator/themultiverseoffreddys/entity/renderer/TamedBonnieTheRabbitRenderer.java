...
@OnlyIn(Dist.CLIENT)
public class TamedBonnieTheRabbitRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedBonnieTheRabbitEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBonnie_the_Rabbit(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/bonnie_the_rabbit.png");
					}
				};
			});
		}
