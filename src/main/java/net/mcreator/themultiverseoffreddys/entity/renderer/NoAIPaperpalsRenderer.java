...
@OnlyIn(Dist.CLIENT)
public class NoAIPaperpalsRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NoAIPaperpalsEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPaperPals(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/paperpals.png");
					}
				};
			});
		}
