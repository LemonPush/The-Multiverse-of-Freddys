...
@OnlyIn(Dist.CLIENT)
public class OldCandyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(OldCandyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelOldCandy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/oldcandy.png");
					}
				};
			});
		}
