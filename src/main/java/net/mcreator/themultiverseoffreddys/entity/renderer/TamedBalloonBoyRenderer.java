...
@OnlyIn(Dist.CLIENT)
public class TamedBalloonBoyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedBalloonBoyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBalloon_Boy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/balloon_boy.png");
					}
				};
			});
		}
