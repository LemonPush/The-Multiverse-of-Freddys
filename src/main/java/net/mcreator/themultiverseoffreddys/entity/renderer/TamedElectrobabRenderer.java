...
@OnlyIn(Dist.CLIENT)
public class TamedElectrobabRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedElectrobabEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBidybab(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/electrobab.png");
					}
				};
			});
		}
