...
@OnlyIn(Dist.CLIENT)
public class TamedToxicSpringtrapRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedToxicSpringtrapEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelToxic_Springtrap(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/toxic_springtrap.png");
					}
				};
			});
		}
	...
	public static class ModelToxic_Springtrap extends EntityModel<Entity> {
		...
		public ModelToxic_Springtrap() {
			...
			head.setTextureOffset(30, 57).addBox(2.5F, -2.947F, 0.8667F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(12, 57).addBox(2.0F, -2.947F, 1.3667F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(6, 57).addBox(-3.0F, -2.947F, 1.3667F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(52, 45).addBox(-2.0F, -2.947F, 2.3667F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(36, 58).addBox(-1.0F, -4.947F, 2.3667F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(58, 0).addBox(-1.0F, -6.447F, 1.8667F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(57, 12).addBox(-1.0F, -7.947F, 0.8667F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(56, 56).addBox(-3.5F, -2.947F, 0.8667F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			...
			head.setTextureOffset(50, 54).addBox(3.0F, -9.247F, -3.7333F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(50, 54).addBox(-1.0F, -9.247F, -3.7333F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			...
			ear_left.setTextureOffset(55, 7).addBox(-1.0F, -4.571F, -0.5485F, 2.0F, 4.0F, 1.0F, 0.0F, false);
			...
			head_r1.setTextureOffset(57, 32).addBox(-1.0F, -3.4861F, 1.0556F, 2.0F, 3.0F, 1.0F, 0.0F, false);
			...
			ear_right.setTextureOffset(55, 7).addBox(-1.0F, -4.571F, -0.5485F, 2.0F, 4.0F, 1.0F, 0.0F, true);
			...
			body.setTextureOffset(24, 59).addBox(-3.0F, 2.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(59, 22).addBox(-3.0F, 4.0F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(18, 59).addBox(-3.0F, 5.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(58, 48).addBox(1.0F, 5.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(50, 58).addBox(1.0F, 4.0F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(0, 59).addBox(1.0F, 2.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			body.setTextureOffset(50, 54).addBox(0.4F, 2.5F, -3.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(50, 54).addBox(-3.5F, 4.5F, -3.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(50, 54).addBox(-3.5F, 4.5F, 1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(50, 54).addBox(0.4F, 2.5F, 1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(50, 54).addBox(-3.5F, 0.5F, 1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			...
			left_arm.setTextureOffset(0, 55).addBox(1.1F, 9.15F, -1.0F, 2.0F, 2.0F, 2.0F, 0.25F, false);
			left_arm.setTextureOffset(50, 54).addBox(3.1F, 5.65F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			...
			right_arm.setTextureOffset(0, 55).addBox(-3.1F, 9.15F, -1.0F, 2.0F, 2.0F, 2.0F, 0.25F, true);
			right_arm.setTextureOffset(50, 54).addBox(-4.6F, -0.35F, -1.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			right_arm.setTextureOffset(50, 54).addBox(-4.6F, 0.65F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			right_arm.setTextureOffset(50, 54).addBox(-2.6F, -2.35F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			...
			left_leg.setTextureOffset(50, 54).addBox(-1.0F, 8.2083F, -2.8333F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			left_leg.setTextureOffset(50, 54).addBox(-1.0F, 3.2083F, -2.8333F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			left_leg.setTextureOffset(50, 54).addBox(-0.5F, 2.2083F, 1.1667F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			...
			right_leg.setTextureOffset(50, 54).addBox(-1.0F, 7.2083F, -2.8333F, 2.0F, 2.0F, 2.0F, 0.0F, false);
