...
import net.mcreator.themultiverseoffreddys.entity.TamedPlushkinBonnieEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class TamedPlushkinBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedPlushkinBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlushkinBonnie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/plushkinbonnie.png");
					}
				};
			});
		}
	...
	public static class ModelPlushkinBonnie extends EntityModel<Entity> {
		...
		public ModelPlushkinBonnie() {
			...
			head.addChild(mask);
			mask.setTextureOffset(17, 9).addBox(-3.5F, -12.5F, -4.5F, 7.0F, 3.0F, 1.0F, 0.0F, false);
			mask.setTextureOffset(0, 2).addBox(-0.5F, -13.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			mask.setTextureOffset(0, 20).addBox(-3.5F, -16.5F, -3.5F, 7.0F, 7.0F, 1.0F, 0.0F, false);
			mask.setTextureOffset(32, 6).addBox(-3.5F, -20.0F, -3.5F, 3.0F, 3.0F, 1.0F, 0.0F, false);
			mask.setTextureOffset(0, 0).addBox(-3.0F, -17.5F, -3.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			mask.setTextureOffset(0, 0).addBox(-3.0F, -21.0F, -3.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			mask.setTextureOffset(32, 6).addBox(-3.5F, -23.5F, -3.5F, 3.0F, 3.0F, 1.0F, 0.0F, false);
			mask.setTextureOffset(0, 0).addBox(1.0F, -21.0F, -3.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);
			mask.setTextureOffset(0, 0).addBox(1.0F, -17.5F, -3.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);
			mask.setTextureOffset(32, 6).addBox(0.5F, -20.0F, -3.5F, 3.0F, 3.0F, 1.0F, 0.0F, true);
			mask.setTextureOffset(32, 6).addBox(0.5F, -23.5F, -3.5F, 3.0F, 3.0F, 1.0F, 0.0F, true);
