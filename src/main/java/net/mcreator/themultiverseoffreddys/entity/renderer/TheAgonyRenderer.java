...
public class TheAgonyRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TheAgonyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTheAgony(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/theagony.png");
					}
				};
			});
		}
