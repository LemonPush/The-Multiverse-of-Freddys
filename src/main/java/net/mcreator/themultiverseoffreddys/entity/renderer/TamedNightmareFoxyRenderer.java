...
@OnlyIn(Dist.CLIENT)
public class TamedNightmareFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedNightmareFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNightmareFoxy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/nightmarefoxy.png");
					}
				};
			});
		}
