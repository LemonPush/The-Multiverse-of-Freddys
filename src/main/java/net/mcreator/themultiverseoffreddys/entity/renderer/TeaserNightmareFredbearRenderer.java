...
@OnlyIn(Dist.CLIENT)
public class TeaserNightmareFredbearRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TeaserNightmareFredbearEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNightmareFredbear(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/teasernightmarefredbear.png");
					}
				};
			});
		}
