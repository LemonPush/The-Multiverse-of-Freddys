...
@OnlyIn(Dist.CLIENT)
public class TamedFlamethrowerBareEndoRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedFlamethrowerBareEndoEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFlamethrower_Bare_Endo(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/flamethrower_bare_endo.png");
					}
				};
			});
		}
