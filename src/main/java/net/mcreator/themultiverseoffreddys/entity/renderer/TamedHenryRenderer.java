...
@OnlyIn(Dist.CLIENT)
public class TamedHenryRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedHenryEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHenry(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/henry.png");
					}
				};
			});
		}
