...
@OnlyIn(Dist.CLIENT)
public class TamedSewerBotRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedSewerBotEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSewerBot(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/sewerbot.png");
					}
				};
			});
		}
	...
	public static class ModelSewerBot extends EntityModel<Entity> {
