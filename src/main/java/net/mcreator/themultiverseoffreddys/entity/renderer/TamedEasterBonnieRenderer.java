...
@OnlyIn(Dist.CLIENT)
public class TamedEasterBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedEasterBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeleaster_bonnie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/easter_bonnie.png");
					}
				};
			});
		}
	...
	public static class Modeleaster_bonnie extends EntityModel<Entity> {
		...
		public Modeleaster_bonnie() {
			...
			head.setTextureOffset(60, 29).addBox(-1.0F, -11.0F, -6.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(61, 7).addBox(-2.7F, -12.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(6, 61).addBox(0.7F, -12.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(42, 58).addBox(0.5F, -18.5F, -0.9F, 3.0F, 4.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(0, 16).addBox(1.5F, -19.5F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 54).addBox(-3.5F, -18.5F, -0.9F, 3.0F, 4.0F, 2.0F, 0.0F, false);
			...
			head_r1.setTextureOffset(52, 58).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 3.0F, 2.0F, 0.0F, false);
			head_r1.setTextureOffset(0, 32).addBox(3.0F, -1.5F, -1.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			head_r1.setTextureOffset(14, 59).addBox(2.5F, -0.5F, -1.5F, 3.0F, 3.0F, 2.0F, 0.0F, false);
			head_r2 = new ModelRenderer(this);
			head_r2.setRotationPoint(5.5F, -20.8465F, -0.5716F);
			head.addChild(head_r2);
			setRotationAngle(head_r2, 0.3843F, -0.0829F, 0.202F);
			head_r2.setTextureOffset(16, 55).addBox(-2.3F, -1.0F, -0.5F, 8.0F, 3.0F, 1.0F, 0.0F, false);
			...
			body.setTextureOffset(0, 61).addBox(-1.0F, -5.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(60, 49).addBox(1.0F, -6.0F, -4.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(60, 40).addBox(-3.0F, -6.0F, -4.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(36, 60).addBox(-6.0F, -5.0F, -0.8F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(30, 60).addBox(5.0F, -5.0F, -0.8F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(60, 26).addBox(-1.0F, 5.0F, -0.8F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(24, 59).addBox(-1.0F, -7.0F, -0.8F, 2.0F, 1.0F, 2.0F, 0.0F, false);
