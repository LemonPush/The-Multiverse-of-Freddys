...
import net.mcreator.themultiverseoffreddys.entity.SunkenToyBonnieEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class SunkenToyBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SunkenToyBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSunken_Toy_Bonnie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/sunken_toy_bonnie.png");
					}
				};
			});
		}
	...
	public static class ModelSunken_Toy_Bonnie extends EntityModel<Entity> {
		...
		public ModelSunken_Toy_Bonnie() {
			...
			head.setTextureOffset(18, 33).addBox(-0.5F, -11.5F, -5.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(18, 32).addBox(-5.5F, -10.0F, -4.0F, 2.0F, 4.0F, 8.0F, 0.0F, true);
			...
			head_r3.setTextureOffset(124, 0).addBox(0.0F, -6.8265F, 1.6148F, 1.0F, 1.0F, 0.0F, 0.25F, true);
			head_r3.setTextureOffset(124, 0).addBox(-1.0F, -7.8265F, 1.6148F, 1.0F, 2.0F, 0.0F, 0.25F, true);
			head_r3.setTextureOffset(0, 60).addBox(-1.5F, -8.2677F, 1.6361F, 2.0F, 2.0F, 2.0F, 0.25F, false);
			head_r3.setTextureOffset(0, 60).addBox(-1.5F, -7.2677F, 1.6361F, 3.0F, 2.0F, 2.0F, 0.25F, false);
			head_r4 = new ModelRenderer(this);
			head_r4.setRotationPoint(2.0F, -14.0235F, -0.3248F);
			head.addChild(head_r4);
			setRotationAngle(head_r4, 0.1309F, 0.0F, 0.1745F);
			head_r4.setTextureOffset(24, 3).addBox(-0.5F, -5.8765F, -0.1752F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head_r4.setTextureOffset(56, 58).addBox(-1.5F, -4.6765F, -0.5752F, 3.0F, 4.0F, 2.0F, 0.25F, false);
			head_r4.setTextureOffset(24, 0).addBox(-0.5F, -0.8765F, -0.1752F, 1.0F, 2.0F, 1.0F, 0.0F, false);
