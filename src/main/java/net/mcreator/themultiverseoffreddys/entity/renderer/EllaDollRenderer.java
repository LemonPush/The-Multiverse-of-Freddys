...
@OnlyIn(Dist.CLIENT)
public class EllaDollRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EllaDollEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelElla(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/ella.png");
					}
				};
			});
		}
