...
@OnlyIn(Dist.CLIENT)
public class TamedHardcoreBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedHardcoreBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBonnie_the_Rabbit(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/neon_bonnie.png");
					}
				};
			});
		}
	...
	public static class ModelBonnie_the_Rabbit extends EntityModel<Entity> {
		...
		public ModelBonnie_the_Rabbit() {
			textureWidth = 128;
			textureHeight = 128;
			head = new ModelRenderer(this);
			head.setRotationPoint(0.01F, -7.7867F, 0.1726F);
			head.setTextureOffset(0, 0).addBox(-4.01F, -8.2133F, -4.1726F, 8.0F, 8.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(52, 16).addBox(-3.41F, -0.2133F, -6.1726F, 7.0F, 1.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(25, 18).addBox(-3.41F, -1.2133F, -6.1726F, 7.0F, 1.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(49, 0).addBox(-3.51F, -3.7133F, -6.9726F, 7.0F, 2.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(29, 54).addBox(-3.01F, -4.2133F, -6.6726F, 6.0F, 1.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(60, 28).addBox(-1.01F, -5.2133F, -6.6726F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(61, 10).addBox(-2.71F, -6.7133F, -4.6726F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(61, 7).addBox(0.69F, -6.7133F, -4.6726F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(18, 34).addBox(-5.01F, -3.7133F, -4.1726F, 1.0F, 3.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(0, 32).addBox(3.99F, -3.7133F, -4.1726F, 1.0F, 3.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(0, 18).addBox(1.49F, -8.7133F, -0.6726F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(56, 22).addBox(0.49F, -12.7133F, -1.0726F, 3.0F, 4.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(0, 16).addBox(1.49F, -13.7133F, -0.6726F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(16, 55).addBox(-3.51F, -12.7133F, -1.0726F, 3.0F, 4.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(0, 6).addBox(-2.51F, -13.7133F, -0.6726F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(4, 6).addBox(-2.51F, -8.7133F, -0.6726F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head_r1 = new ModelRenderer(this);
			head_r1.setRotationPoint(-2.01F, -16.2133F, -0.5726F);
			...
			head_r1.setTextureOffset(26, 58).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 3.0F, 2.0F, 0.0F, false);
			head_r1.setTextureOffset(0, 32).addBox(3.0F, -1.5F, -1.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			head_r1.setTextureOffset(36, 58).addBox(2.5F, -0.5F, -1.5F, 3.0F, 3.0F, 2.0F, 0.0F, false);
			...
			body.setTextureOffset(54, 5).addBox(-3.0F, -5.0F, -3.5F, 6.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(6, 61).addBox(-1.0F, -5.0F, -4.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(0, 61).addBox(0.5F, -5.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(60, 49).addBox(-2.5F, -5.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			...
			body.setTextureOffset(54, 58).addBox(-1.0F, 5.0F, -0.8F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(46, 58).addBox(-1.0F, -7.0F, -0.8F, 2.0F, 1.0F, 2.0F, 0.0F, false);
