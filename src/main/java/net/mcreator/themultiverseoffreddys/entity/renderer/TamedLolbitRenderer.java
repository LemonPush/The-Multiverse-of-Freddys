...
@OnlyIn(Dist.CLIENT)
public class TamedLolbitRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedLolbitEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLolbit(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/lolbit.png");
					}
				};
			});
		}
