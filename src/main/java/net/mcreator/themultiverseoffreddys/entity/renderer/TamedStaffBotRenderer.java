...
@OnlyIn(Dist.CLIENT)
public class TamedStaffBotRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedStaffBotEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelStaffBot(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/staffbot.png");
					}
				};
			});
		}
	...
	public static class ModelStaffBot extends EntityModel<Entity> {
