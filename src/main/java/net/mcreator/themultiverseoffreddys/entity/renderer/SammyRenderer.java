...
import net.mcreator.themultiverseoffreddys.entity.SammyEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class SammyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SammyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSammyPuppet(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/sammypuppet.png");
					}
				};
			});
		}
	...
	public static class ModelSammyPuppet extends EntityModel<Entity> {
		...
		public ModelSammyPuppet() {
			...
			body.setTextureOffset(52, 0).addBox(-1.5F, -14.3F, -2.05F, 3.0F, 3.0F, 3.0F, -1.0F, false);
			body.setTextureOffset(24, 21).addBox(-3.5F, -14.8F, -2.05F, 4.0F, 4.0F, 3.0F, -1.0F, false);
			body.setTextureOffset(24, 21).addBox(-0.5F, -14.8F, -2.05F, 4.0F, 4.0F, 3.0F, -1.0F, true);
			...
			body.setTextureOffset(34, 6).addBox(-1.0F, -18.0F, -0.5F, 2.0F, 4.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(32, 28).addBox(-1.0F, -6.0F, -0.5F, 2.0F, 4.0F, 2.0F, 0.0F, false);
			...
			right_leg.setTextureOffset(24, 28).addBox(-1.5F, -0.425F, -1.2227F, 2.0F, 11.0F, 2.0F, 0.0F, true);
			...
			left_leg.setTextureOffset(24, 28).addBox(-0.5F, -0.425F, -1.2227F, 2.0F, 11.0F, 2.0F, 0.0F, false);
