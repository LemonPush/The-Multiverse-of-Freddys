...
@OnlyIn(Dist.CLIENT)
public class IgnitedGoldenFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IgnitedGoldenFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIgnitedGoldenFreddy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/ignitedgoldenfreddy.png");
					}
				};
			});
		}
	...
	public static class ModelIgnitedGoldenFreddy extends EntityModel<Entity> {
		...
		public ModelIgnitedGoldenFreddy() {
			textureWidth = 128;
			textureHeight = 128;
			...
			body.setTextureOffset(75, 65).addBox(-1.0F, -7.2174F, 0.5505F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(75, 65).addBox(-1.0F, -8.2174F, 0.5505F, 2.0F, 1.0F, 2.0F, 0.0F, false);
