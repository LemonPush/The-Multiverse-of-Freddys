...
import net.mcreator.themultiverseoffreddys.entity.NoAiRockstarFreddyEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class NoAiRockstarFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NoAiRockstarFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRockstarFreddy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/rockstarfreddy.png");
					}
				};
			});
		}
	...
	public static class ModelRockstarFreddy extends EntityModel<Entity> {
		...
		public ModelRockstarFreddy() {
			...
			head.setTextureOffset(90, 95).addBox(3.5F, -7.0F, -4.0F, 1.0F, 1.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(90, 95).addBox(-4.5F, -7.0F, -4.0F, 1.0F, 1.0F, 8.0F, 0.0F, true);
			...
			right_arm.setTextureOffset(58, 54).addBox(-4.0F, 10.5F, -2.8F, 2.0F, 2.0F, 4.0F, 0.0F, false);
			right_arm.setTextureOffset(48, 58).addBox(-4.8F, 10.0F, -5.8F, 3.0F, 3.0F, 3.0F, 0.0F, false);
