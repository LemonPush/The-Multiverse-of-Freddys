...
import net.mcreator.themultiverseoffreddys.entity.SaffronEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class SaffronRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SaffronEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSaffron(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/saffron.png");
					}
				};
			});
		}
	...
	public static class ModelSaffron extends EntityModel<Entity> {
		...
		public ModelSaffron() {
			...
			head.setTextureOffset(48, 19).addBox(-4.5F, -10.5F, -4.0F, 1.0F, 4.0F, 8.0F, 0.0F, true);
			head.setTextureOffset(48, 19).addBox(3.5F, -10.5F, -4.0F, 1.0F, 4.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(0, 48).addBox(-1.0F, -15.0F, -3.2F, 3.0F, 1.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(0, 38).addBox(-3.0F, -15.0F, -5.0F, 3.0F, 1.0F, 9.0F, 0.0F, false);
			head.setTextureOffset(40, 51).addBox(-3.0F, -16.0F, -4.0F, 3.0F, 1.0F, 7.0F, 0.0F, false);
			head.setTextureOffset(53, 51).addBox(-4.5F, -15.0F, 2.0F, 4.0F, 3.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(46, 64).addBox(-3.5F, -12.0F, 2.0F, 3.0F, 3.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(55, 0).addBox(-2.0F, -7.5F, -6.5F, 4.0F, 1.0F, 3.0F, 0.0F, false);
			head.setTextureOffset(58, 24).addBox(-2.0F, -8.5F, -6.2F, 4.0F, 1.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(55, 43).addBox(-2.0F, -10.5F, -6.5F, 4.0F, 2.0F, 3.0F, 0.0F, false);
			...
			head_r3.setTextureOffset(38, 16).addBox(1.1F, -0.5F, -3.9F, 1.0F, 1.0F, 7.0F, 0.0F, false);
			...
			body.setTextureOffset(55, 31).addBox(-1.5F, -8.8F, 11.9F, 3.0F, 10.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(58, 14).addBox(-1.5F, -8.8F, 4.9F, 3.0F, 8.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(58, 57).addBox(-1.5F, -7.8F, 13.9F, 3.0F, 8.0F, 2.0F, 0.0F, false);
			...
			body.setTextureOffset(14, 51).addBox(-1.0F, 5.0F, -0.8F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			...
			left_leg.setTextureOffset(12, 57).addBox(-1.6F, 1.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.25F, false);
			left_leg.setTextureOffset(57, 4).addBox(-1.6F, 8.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.25F, false);
			left_leg.setTextureOffset(0, 51).addBox(-1.1F, 7.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			left_leg.setTextureOffset(14, 48).addBox(-1.1F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			...
			right_leg.setTextureOffset(0, 57).addBox(-1.4F, 1.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.25F, false);
			right_leg.setTextureOffset(15, 38).addBox(-1.4F, 8.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.25F, false);
			right_leg.setTextureOffset(0, 48).addBox(-0.9F, 7.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			right_leg.setTextureOffset(47, 19).addBox(-0.9F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			...
			left_arm.setTextureOffset(24, 60).addBox(0.5F, -1.0F, -2.0F, 3.0F, 5.0F, 3.0F, 0.25F, false);
			left_arm.setTextureOffset(37, 59).addBox(0.5F, 5.0F, -2.0F, 3.0F, 5.0F, 3.0F, 0.25F, false);
			...
			left_arm.setTextureOffset(64, 48).addBox(0.5F, 11.0F, -2.0F, 3.0F, 3.0F, 3.0F, 0.25F, false);
			right_arm = new ModelRenderer(this);
			right_arm.setRotationPoint(-4.5F, -5.3F, 0.5F);
			right_arm.setTextureOffset(24, 60).addBox(-3.5F, -1.0F, -2.0F, 3.0F, 5.0F, 3.0F, 0.25F, true);
			right_arm.setTextureOffset(37, 59).addBox(-3.5F, 5.0F, -2.0F, 3.0F, 5.0F, 3.0F, 0.25F, true);
			...
			right_arm.setTextureOffset(64, 48).addBox(-3.5F, 11.0F, -2.0F, 3.0F, 3.0F, 3.0F, 0.25F, true);
		}
