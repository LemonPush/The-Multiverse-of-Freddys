...
import net.mcreator.themultiverseoffreddys.entity.FazGooBruteEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class FazGooBruteRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FazGooBruteEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFaz_Goo_Brute(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/faz_goo_brute.png");
					}
				};
			});
		}
