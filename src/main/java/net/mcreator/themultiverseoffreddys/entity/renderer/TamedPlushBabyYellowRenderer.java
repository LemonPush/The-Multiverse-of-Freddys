...
@OnlyIn(Dist.CLIENT)
public class TamedPlushBabyYellowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedPlushBabyYellowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlushbaby_noeye(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/plushbabyyellow.png");
					}
				};
			});
		}
