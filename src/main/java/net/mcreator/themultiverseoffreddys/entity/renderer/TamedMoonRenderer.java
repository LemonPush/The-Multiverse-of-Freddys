...
@OnlyIn(Dist.CLIENT)
public class TamedMoonRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedMoonEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMoon(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/moon.png");
					}
				};
			});
		}
	...
	public static class ModelMoon extends EntityModel<Entity> {
		...
		public ModelMoon() {
			...
			head.setTextureOffset(40, 12).addBox(-0.3125F, -3.7031F, -2.8438F, 4.0F, 1.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(41, 26).addBox(-0.3125F, 0.2969F, -2.8438F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			head_r1.setRotationPoint(-0.3125F, -3.2031F, -1.6438F);
			head.addChild(head_r1);
			setRotationAngle(head_r1, -0.2618F, 0.0F, 0.0F);
			head_r1.setTextureOffset(38, 61).addBox(-1.0F, -4.0F, 1.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			head_r1.setTextureOffset(20, 60).addBox(-1.0F, -3.5F, 3.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);
			head_r1.setTextureOffset(0, 55).addBox(-0.5F, -0.5F, 3.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head_r1.setTextureOffset(0, 59).addBox(-1.5F, -3.5F, -1.5F, 3.0F, 2.0F, 3.0F, 0.0F, false);
			head_r1.setTextureOffset(48, 58).addBox(-2.0F, -1.5F, -2.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);
			...
			left_leg.setTextureOffset(48, 17).addBox(-0.5F, 8.75F, -3.5833F, 1.0F, 1.0F, 1.0F, 0.0F, false);
