...
@OnlyIn(Dist.CLIENT)
public class TamedShamrockFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedShamrockFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFreddy_Fazbear(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/shamrock_freddy.png");
					}
				};
			});
		}
