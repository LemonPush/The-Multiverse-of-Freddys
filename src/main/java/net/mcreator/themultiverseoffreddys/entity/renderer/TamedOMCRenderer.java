...
@OnlyIn(Dist.CLIENT)
public class TamedOMCRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedOMCEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelOMC(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/omc.png");
					}
				};
			});
		}
