...
import net.mcreator.themultiverseoffreddys.entity.TamedPlushScrapBabyYellowEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class TamedPlushScrapBabyYellowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedPlushScrapBabyYellowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlushbaby_noeye(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/plushscrapbabyyellow.png");
					}
				};
			});
		}
	...
	public static class ModelPlushbaby_noeye extends EntityModel<Entity> {
