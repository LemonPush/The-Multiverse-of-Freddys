...
@OnlyIn(Dist.CLIENT)
public class CharlieBotRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CharlieBotEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelCharlieBot(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/charliebot.png");
					}
				};
			});
		}
	...
	public static class ModelCharlieBot extends EntityModel<Entity> {
