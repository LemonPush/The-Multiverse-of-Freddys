...
@OnlyIn(Dist.CLIENT)
public class NoAIWitheredFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NoAIWitheredFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelWitheredFoxy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/withered_foxy.png");
					}
				};
			});
		}
	...
	public static class ModelWitheredFoxy extends EntityModel<Entity> {
		...
		public ModelWitheredFoxy() {
			...
			right_arm_r3.setTextureOffset(40, 69).addBox(9.0F, 8.0F, -16.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			right_arm_r3.setTextureOffset(40, 69).addBox(13.0F, 8.0F, -16.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
			right_arm_r3.setTextureOffset(66, 0).addBox(10.0F, 8.0F, -16.5F, 3.0F, 2.0F, 3.0F, 0.0F, false);
			...
			body.setTextureOffset(0, 12).addBox(-5.0F, -1.0F, -2.5F, 10.0F, 9.0F, 5.0F, 0.25F, false);
			body.setTextureOffset(0, 26).addBox(-3.5F, -1.0F, -2.7F, 7.0F, 10.0F, 5.0F, 0.25F, false);
			body.setTextureOffset(25, 21).addBox(-4.0F, 2.0F, -2.5F, 8.0F, 10.0F, 5.0F, 0.25F, false);
			...
			left_arm.setTextureOffset(60, 61).addBox(0.5F, -1.0F, -2.0F, 3.0F, 6.0F, 4.0F, 0.25F, false);
			...
			right_arm.setTextureOffset(50, 55).addBox(-3.5F, 6.0F, -2.0F, 3.0F, 6.0F, 4.0F, 0.25F, false);
			right_arm_r4 = new ModelRenderer(this);
			right_arm_r4.setRotationPoint(-2.0F, 14.5F, 0.0F);
			right_arm.addChild(right_arm_r4);
			setRotationAngle(right_arm_r4, 0.0F, 0.0F, 2.0508F);
			right_arm_r4.setTextureOffset(0, 12).addBox(3.9F, -2.7F, -0.5F, 1.0F, 2.0F, 1.0F, 0.25F, false);
			right_arm_r5 = new ModelRenderer(this);
			right_arm_r5.setRotationPoint(-2.0F, 14.5F, 0.0F);
			right_arm.addChild(right_arm_r5);
			setRotationAngle(right_arm_r5, 0.0F, 0.0F, 0.6545F);
			right_arm_r5.setTextureOffset(0, 12).addBox(0.1F, 0.8F, -0.5F, 1.0F, 2.0F, 1.0F, 0.25F, false);
