...
import net.mcreator.themultiverseoffreddys.entity.BlacklightBBEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class BlacklightBBRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BlacklightBBEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBalloon_Boy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/blacklight_balloon_boy.png");
					}
				};
			});
		}
	...
	public static class ModelBalloon_Boy extends EntityModel<Entity> {
		...
		public ModelBalloon_Boy() {
			...
			head.setTextureOffset(24, 0).addBox(-4.1F, -5.1F, -3.9F, 2.0F, 2.0F, 2.0F, -0.5F, false);
			head.setTextureOffset(24, 0).addBox(2.1F, -5.1F, -3.9F, 2.0F, 2.0F, 2.0F, -0.5F, false);
			...
			body.setTextureOffset(44, 52).addBox(-1.0F, 7.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);
			...
			button_r1.setTextureOffset(32, 51).addBox(-2.5F, -0.9F, -7.3F, 5.0F, 5.0F, 1.0F, -1.5F, false);
			button_r1.setTextureOffset(32, 51).addBox(-2.5F, -3.1F, -7.3F, 5.0F, 5.0F, 1.0F, -1.5F, false);
