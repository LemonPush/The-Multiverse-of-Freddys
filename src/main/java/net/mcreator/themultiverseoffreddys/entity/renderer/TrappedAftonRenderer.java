...
@OnlyIn(Dist.CLIENT)
public class TrappedAftonRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TrappedAftonEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTrapped_Afton(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/trapped_afton.png");
					}
				};
			});
		}
