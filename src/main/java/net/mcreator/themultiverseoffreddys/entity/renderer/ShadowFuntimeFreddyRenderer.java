...
import net.mcreator.themultiverseoffreddys.entity.ShadowFuntimeFreddyEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ShadowFuntimeFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ShadowFuntimeFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelShadowFuntimeFreddy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/shadowfuntimefreddy.png");
					}
				};
			});
		}
	...
	public static class ModelShadowFuntimeFreddy extends EntityModel<Entity> {
		...
		public ModelShadowFuntimeFreddy() {
			textureWidth = 128;
			textureHeight = 128;
			...
			head.addChild(bone);
			bone.setTextureOffset(25, 16).addBox(-3.5F, -17.5F, -5.0F, 7.0F, 1.0F, 3.0F, 0.0F, false);
			...
			bone_r2.setTextureOffset(46, 24).addBox(-3.5F, 0.1F, -5.7F, 7.0F, 1.0F, 3.0F, 0.0F, false);
			bone_r2.setTextureOffset(46, 24).addBox(-3.5F, -0.9F, -5.7F, 7.0F, 1.0F, 3.0F, 0.0F, false);
			...
			body.setTextureOffset(76, 0).addBox(-4.0F, 12.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, false);
