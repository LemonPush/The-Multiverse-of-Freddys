...
@OnlyIn(Dist.CLIENT)
public class InTheFleshRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(InTheFleshEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFetustrap(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/fetustrap.png");
					}
				};
			});
		}
