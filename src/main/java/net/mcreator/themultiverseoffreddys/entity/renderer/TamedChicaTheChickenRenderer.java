...
@OnlyIn(Dist.CLIENT)
public class TamedChicaTheChickenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedChicaTheChickenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelChica_the_Chicken(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/chica_the_chicken.png");
					}
				};
			});
		}
