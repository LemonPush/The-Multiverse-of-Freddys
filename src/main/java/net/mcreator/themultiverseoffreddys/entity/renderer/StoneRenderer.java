...
import net.mcreator.themultiverseoffreddys.entity.StoneEntity;
...
public class StoneRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(StoneEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelStone(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/stone.png");
					}
				};
			});
		}
