...
@OnlyIn(Dist.CLIENT)
public class TamedPlushtrapRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedPlushtrapEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlushTrap(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/plushtrap.png");
					}
				};
			});
		}
