...
@OnlyIn(Dist.CLIENT)
public class FetchRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FetchEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFetch(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/fetch.png");
					}
				};
			});
		}
