...
import net.mcreator.themultiverseoffreddys.entity.TamedPlushScrapBabyEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class TamedPlushScrapBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedPlushScrapBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlushbaby(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/plushscrapbaby.png");
					}
				};
			});
		}
