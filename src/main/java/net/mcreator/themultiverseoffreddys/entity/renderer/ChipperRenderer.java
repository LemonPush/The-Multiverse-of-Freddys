...
@OnlyIn(Dist.CLIENT)
public class ChipperRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ChipperEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelChipper(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/chipper.png");
					}
				};
			});
		}
