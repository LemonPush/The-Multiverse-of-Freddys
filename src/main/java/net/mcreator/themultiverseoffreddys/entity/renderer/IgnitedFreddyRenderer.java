...
@OnlyIn(Dist.CLIENT)
public class IgnitedFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IgnitedFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIgnitedFreddy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/ignitedfreddy.png");
					}
				};
			});
		}
