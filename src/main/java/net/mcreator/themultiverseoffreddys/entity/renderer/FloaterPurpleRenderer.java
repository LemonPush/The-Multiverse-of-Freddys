...
@OnlyIn(Dist.CLIENT)
public class FloaterPurpleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FloaterPurpleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFloater(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/floater_purple.png");
					}
				};
			});
		}
