...
@OnlyIn(Dist.CLIENT)
public class HeToldMeEverythingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HeToldMeEverythingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFaz_Goo(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/faz-goo.png");
					}
				};
			});
		}
