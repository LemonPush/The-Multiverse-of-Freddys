...
@OnlyIn(Dist.CLIENT)
public class TheFaceRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TheFaceEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelThe_Face(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/the_face.png");
					}
				};
			});
		}
