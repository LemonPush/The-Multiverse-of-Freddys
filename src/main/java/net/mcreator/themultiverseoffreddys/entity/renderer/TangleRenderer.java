...
@OnlyIn(Dist.CLIENT)
public class TangleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TangleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMangle(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/tangle.png");
					}
				};
			});
		}
