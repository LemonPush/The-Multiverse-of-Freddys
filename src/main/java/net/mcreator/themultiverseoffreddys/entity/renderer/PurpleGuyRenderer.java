...
import net.mcreator.themultiverseoffreddys.entity.PurpleGuyEntity;
...
public class PurpleGuyRenderer {
			...
			RenderingRegistry.registerEntityRenderingHandler(PurpleGuyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPurpleGuy(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/purpleguy.png");
					}
				};
			});
		}
	...
	public static class ModelPurpleGuy extends EntityModel<Entity> {
		...
		public ModelPurpleGuy() {
			...
			head.addChild(bone);
			bone.setTextureOffset(0, 19).addBox(-4.7164F, -13.5321F, -2.2274F, 9.0F, 6.0F, 7.0F, 0.0F, false);
			bone.setTextureOffset(32, 0).addBox(-4.7164F, -6.5321F, 2.7726F, 9.0F, 2.0F, 2.0F, 0.0F, false);
			bone.setTextureOffset(32, 0).addBox(-4.7164F, -7.5321F, -0.2274F, 9.0F, 4.0F, 5.0F, 0.0F, false);
			...
			bone_r1.setTextureOffset(67, 6).addBox(-4.7164F, 0.993F, -3.2527F, 1.0F, 2.0F, 7.0F, 0.0F, true);
			bone_r1.setTextureOffset(67, 6).addBox(3.2836F, 0.993F, -3.2527F, 1.0F, 2.0F, 7.0F, 0.0F, false);
			bone_r1.setTextureOffset(100, 0).addBox(-3.7164F, 0.993F, -3.2527F, 7.0F, 2.0F, 7.0F, 0.0F, false);
			...
			body.setTextureOffset(120, 13).addBox(1.0F, -3.4174F, -2.4495F, 3.0F, 3.0F, 1.0F, 0.0F, false);
			...
			body.setTextureOffset(107, 25).addBox(-1.0F, -6.2174F, 0.5505F, 2.0F, 1.0F, 2.0F, 0.0F, false);
