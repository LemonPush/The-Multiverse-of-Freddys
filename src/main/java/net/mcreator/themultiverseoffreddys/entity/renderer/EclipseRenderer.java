...
public class EclipseRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EclipseEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSun(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/eclipse.png");
					}
				};
			});
		}
