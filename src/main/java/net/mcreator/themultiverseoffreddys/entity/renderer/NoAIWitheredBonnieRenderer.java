...
@OnlyIn(Dist.CLIENT)
public class NoAIWitheredBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NoAIWitheredBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelWitheredBonnie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/witheredbonnie.png");
					}
				};
			});
		}
