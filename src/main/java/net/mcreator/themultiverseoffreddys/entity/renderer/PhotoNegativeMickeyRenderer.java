...
@OnlyIn(Dist.CLIENT)
public class PhotoNegativeMickeyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PhotoNegativeMickeyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPhotoNegative_Mickey(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/photonegative_mickey.png");
					}
				};
			});
		}
	...
	public static class ModelPhotoNegative_Mickey extends EntityModel<Entity> {
		...
		public ModelPhotoNegative_Mickey() {
			textureWidth = 64;
			textureHeight = 64;
