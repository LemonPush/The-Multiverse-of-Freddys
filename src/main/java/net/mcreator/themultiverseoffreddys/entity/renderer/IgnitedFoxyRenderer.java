...
@OnlyIn(Dist.CLIENT)
public class IgnitedFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IgnitedFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIgnitedFoxy(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/ignitedfoxy.png");
					}
				};
			});
		}
