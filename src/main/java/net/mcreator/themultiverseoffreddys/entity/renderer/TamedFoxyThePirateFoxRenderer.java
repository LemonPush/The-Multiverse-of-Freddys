...
@OnlyIn(Dist.CLIENT)
public class TamedFoxyThePirateFoxRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TamedFoxyThePirateFoxEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFoxy_the_Pirate_Fox(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/foxy_the_pirate_fox.png");
					}
				};
			});
		}
