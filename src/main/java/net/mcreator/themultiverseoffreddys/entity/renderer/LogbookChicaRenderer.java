...
@OnlyIn(Dist.CLIENT)
public class LogbookChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(LogbookChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLogbook_Chica(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ultimate_fnaf_mod:textures/entities/logbook_chica.png");
					}
				};
			});
		}
