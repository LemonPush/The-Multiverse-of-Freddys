...
import net.mcreator.themultiverseoffreddys.entity.renderer.WilliamAftonRenderer;
...
public class WilliamAftonEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -10092442, new Item.Properties().group(FNaF3TabItemGroup.tab))
				.setRegistryName("william_afton_spawn_egg"));
	}
