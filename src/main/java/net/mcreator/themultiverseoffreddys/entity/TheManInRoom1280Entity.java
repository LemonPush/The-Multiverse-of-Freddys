...
import net.mcreator.themultiverseoffreddys.procedures.TOYSNHKFreeProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.FFTabItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.TheManInRoom1280Renderer;
...
public class TheManInRoom1280Entity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750055, -16764007, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("the_man_in_room_1280_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TOYSNHKFreeProcedure.executeProcedure(Stream
