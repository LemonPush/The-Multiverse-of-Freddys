...
import net.mcreator.themultiverseoffreddys.procedures.ScrapLootProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.MoltenFreddyRenderer;
...
public class MoltenFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6579301, -10079488, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("molten_freddy_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:molten6"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			ScrapLootProcedure.executeProcedure(Stream
