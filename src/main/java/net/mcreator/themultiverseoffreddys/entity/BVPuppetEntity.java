...
import net.mcreator.themultiverseoffreddys.entity.renderer.BVPuppetRenderer;
...
public class BVPuppetEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(F1ItemGroup.tab)).setRegistryName("bv_puppet_spawn_egg"));
	}
