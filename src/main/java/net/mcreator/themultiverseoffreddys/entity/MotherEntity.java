...
import net.mcreator.themultiverseoffreddys.entity.renderer.MotherRenderer;
...
public class MotherEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("mother_spawn_egg"));
	}
