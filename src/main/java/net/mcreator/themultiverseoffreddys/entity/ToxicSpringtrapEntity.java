...
import net.mcreator.themultiverseoffreddys.procedures.ToxicSpringtrapPlayerCollidesWithThisEntityProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.ToxicSpringtrapRenderer;
...
public class ToxicSpringtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -13421773, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("toxic_springtrap_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			ToxicSpringtrapPlayerCollidesWithThisEntityProcedure
