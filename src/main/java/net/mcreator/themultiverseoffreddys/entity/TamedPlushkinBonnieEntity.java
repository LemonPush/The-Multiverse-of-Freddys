...
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedPlushkinBonnieRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class TamedPlushkinBonnieEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.9f)).build("tamed_plushkin_bonnie").setRegistryName("tamed_plushkin_bonnie");

	public TamedPlushkinBonnieEntity(UltimateFnafModModElements instance) {
		super(instance, 1068);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedPlushkinBonnieRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.fromItems(CandyItem.block), false));
