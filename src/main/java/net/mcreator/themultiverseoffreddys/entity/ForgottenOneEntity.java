...
import net.mcreator.themultiverseoffreddys.entity.renderer.ForgottenOneRenderer;
...
public class ForgottenOneEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -256, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("forgotten_one_spawn_egg"));
	}
