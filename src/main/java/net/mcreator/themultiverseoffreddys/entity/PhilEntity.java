...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhilRenderer;
...
public class PhilEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -10092544, -3355444, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("phil_spawn_egg"));
	}
