...
import net.mcreator.themultiverseoffreddys.entity.renderer.JJRenderer;
...
public class JJEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -12764697, new Item.Properties().group(FNaF2TabItemGroup.tab))
				.setRegistryName("jj_spawn_egg"));
	}
