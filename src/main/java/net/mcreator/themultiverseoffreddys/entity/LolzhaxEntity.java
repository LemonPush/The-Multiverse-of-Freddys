...
import net.mcreator.themultiverseoffreddys.entity.renderer.LolzhaxRenderer;
...
public class LolzhaxEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -3355444, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("lolzhax_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ChipDefenceItem.block));
		}
