...
import net.mcreator.themultiverseoffreddys.procedures.TamedSpringtrapRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.item.AgonyItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedSpringtrapRenderer;
...
public class TamedSpringtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedSpringtrapRightClickedOnEntityProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
