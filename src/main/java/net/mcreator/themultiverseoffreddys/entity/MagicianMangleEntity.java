...
import net.mcreator.themultiverseoffreddys.entity.renderer.MagicianMangleRenderer;
...
public class MagicianMangleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -10079488, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("magician_mangle_spawn_egg"));
	}
