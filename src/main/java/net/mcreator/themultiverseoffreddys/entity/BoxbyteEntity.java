...
import net.mcreator.themultiverseoffreddys.entity.renderer.BoxbyteRenderer;
...
public class BoxbyteEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -13421773, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("boxbyte_spawn_egg"));
	}
