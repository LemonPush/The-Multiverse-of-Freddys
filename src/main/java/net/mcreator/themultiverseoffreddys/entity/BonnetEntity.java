...
import net.mcreator.themultiverseoffreddys.entity.renderer.BonnetRenderer;
...
public class BonnetEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1951637, -230978, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("bonnet_spawn_egg"));
	}
