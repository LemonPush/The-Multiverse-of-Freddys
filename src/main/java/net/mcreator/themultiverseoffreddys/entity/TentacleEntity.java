...
import net.mcreator.themultiverseoffreddys.itemgroup.F5ItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.TentacleRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class TentacleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6710887, new Item.Properties().group(F5ItemGroup.tab))
				.setRegistryName("tentacle_spawn_egg"));
	}
