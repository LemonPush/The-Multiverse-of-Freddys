...
import net.mcreator.themultiverseoffreddys.entity.renderer.MinireenaRenderer;
...
public class MinireenaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4806047, -1, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("minireena_spawn_egg"));
	}
