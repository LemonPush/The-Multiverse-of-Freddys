...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlacklightSpringtrapRenderer;
...
public class BlacklightSpringtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737895, -10092442, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("blacklight_springtrap_spawn_egg"));
	}
