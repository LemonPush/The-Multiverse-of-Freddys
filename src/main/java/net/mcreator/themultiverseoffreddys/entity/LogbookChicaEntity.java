...
import net.mcreator.themultiverseoffreddys.entity.renderer.LogbookChicaRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class LogbookChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -6737152, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("logbook_chica_spawn_egg"));
	}
