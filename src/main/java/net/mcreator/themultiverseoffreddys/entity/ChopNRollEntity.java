...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChopNRollRenderer;
...
public class ChopNRollEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6724096, new Item.Properties().group(F2ItemGroup.tab))
				.setRegistryName("chop_n_roll_spawn_egg"));
	}
