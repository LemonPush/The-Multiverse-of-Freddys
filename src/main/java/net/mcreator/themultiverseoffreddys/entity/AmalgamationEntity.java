...
import net.mcreator.themultiverseoffreddys.entity.renderer.AmalgamationRenderer;
...
public class AmalgamationEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -13487566, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("amalgamation_spawn_egg"));
	}
