...
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedFredbearRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class TamedFredbearEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("tamed_fredbear").setRegistryName("tamed_fredbear");

	public TamedFredbearEntity(UltimateFnafModModElements instance) {
		super(instance, 1044);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedFredbearRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(CakeSliceItem.block), false));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (CakeSliceItem.block == stack.getItem())
				return true;
			return false;
		}
	}
