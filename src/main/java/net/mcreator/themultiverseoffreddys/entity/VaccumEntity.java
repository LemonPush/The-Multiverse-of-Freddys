...
import net.mcreator.themultiverseoffreddys.entity.renderer.VaccumRenderer;
...
public class VaccumEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -16764160, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("vaccum_spawn_egg"));
	}
