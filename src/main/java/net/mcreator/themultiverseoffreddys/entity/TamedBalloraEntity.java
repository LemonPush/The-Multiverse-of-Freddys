...
import net.mcreator.themultiverseoffreddys.procedures.TamedBalloraHurtProcedure;
import net.mcreator.themultiverseoffreddys.item.RemnantItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedBalloraRenderer;
...
public class TamedBalloraEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TamedBalloraHurtProcedure.executeProcedure(Stream
