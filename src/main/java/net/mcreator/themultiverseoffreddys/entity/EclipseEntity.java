...
import net.mcreator.themultiverseoffreddys.entity.renderer.EclipseRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class EclipseEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6724096, -13434880, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("eclipse_spawn_egg"));
	}
