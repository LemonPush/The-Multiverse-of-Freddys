...
import net.mcreator.themultiverseoffreddys.entity.renderer.GamesRenderer;
...
public class GamesEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -3355648, -256, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("games_spawn_egg"));
	}
