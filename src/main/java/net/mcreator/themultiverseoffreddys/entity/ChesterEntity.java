...
import net.mcreator.themultiverseoffreddys.entity.renderer.ChesterRenderer;
...
public class ChesterEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -5862028, new Item.Properties().group(CandyTabItemGroup.tab))
				.setRegistryName("chester_spawn_egg"));
	}
