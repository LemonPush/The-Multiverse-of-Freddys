...
import net.mcreator.themultiverseoffreddys.entity.renderer.OrvilleElephantRenderer;
...
public class OrvilleElephantEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -44032, -2974359, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("orville_elephant_spawn_egg"));
	}
