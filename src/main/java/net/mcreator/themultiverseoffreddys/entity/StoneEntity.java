...
import net.mcreator.themultiverseoffreddys.entity.renderer.StoneRenderer;
...
public class StoneEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777165, -10066330, new Item.Properties().group(PopgoesTabItemGroup.tab))
				.setRegistryName("stone_spawn_egg"));
	}
