...
import net.mcreator.themultiverseoffreddys.entity.renderer.BuffyRenderer;
...
public class BuffyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("buffy").setRegistryName("buffy");

	public BuffyEntity(UltimateFnafModModElements instance) {
		super(instance, 342);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BuffyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -13159, new Item.Properties().group(F4ItemGroup.tab)).setRegistryName("buffy_spawn_egg"));
	}
