...
import net.mcreator.themultiverseoffreddys.entity.renderer.GlamrockBonnieRenderer;
...
public class GlamrockBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777012, -10092442, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("glamrock_bonnie_spawn_egg"));
	}
