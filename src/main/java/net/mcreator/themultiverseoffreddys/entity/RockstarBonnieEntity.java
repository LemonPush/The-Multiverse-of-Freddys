...
import net.mcreator.themultiverseoffreddys.entity.renderer.RockstarBonnieRenderer;
...
public class RockstarBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15782533, -14401139, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("rockstar_bonnie_spawn_egg"));
	}
