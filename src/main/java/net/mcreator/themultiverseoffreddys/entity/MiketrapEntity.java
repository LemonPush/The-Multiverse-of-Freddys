...
import net.mcreator.themultiverseoffreddys.entity.renderer.MiketrapRenderer;
...
public class MiketrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -10066432, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("miketrap_spawn_egg"));
	}
