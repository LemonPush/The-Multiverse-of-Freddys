...
import net.mcreator.themultiverseoffreddys.procedures.TamedMapbotRightClickProcedure;
import net.mcreator.themultiverseoffreddys.item.BatteryItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedMapBotRenderer;
...
public class TamedMapBotEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TamedMapbotRightClickProcedure.executeProcedure(Stream
