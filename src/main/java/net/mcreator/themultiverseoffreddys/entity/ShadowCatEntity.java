...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShadowCatRenderer;
...
public class ShadowCatEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14215114, -13889475, new Item.Properties().group(CandyTabItemGroup.tab))
				.setRegistryName("shadow_cat_spawn_egg"));
	}
