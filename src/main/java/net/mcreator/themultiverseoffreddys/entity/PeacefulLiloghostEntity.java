...
import net.mcreator.themultiverseoffreddys.procedures.PeacefulLiloghostEntityDiesProcedure;
import net.mcreator.themultiverseoffreddys.entity.renderer.PeacefulLiloghostRenderer;
...
public class PeacefulLiloghostEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			PeacefulLiloghostEntityDiesProcedure.executeProcedure(Stream
