...
import net.mcreator.themultiverseoffreddys.entity.renderer.ClockworkBalloraRenderer;
...
public class ClockworkBalloraEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -11263744, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("clockwork_ballora_spawn_egg"));
	}
