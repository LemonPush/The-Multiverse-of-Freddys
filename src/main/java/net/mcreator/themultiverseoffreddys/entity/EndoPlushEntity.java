...
import net.mcreator.themultiverseoffreddys.entity.renderer.EndoPlushRenderer;
...
public class EndoPlushEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -13421773, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("endo_plush_spawn_egg"));
	}
