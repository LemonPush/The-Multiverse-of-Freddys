...
import net.mcreator.themultiverseoffreddys.entity.renderer.StaffBotRenderer;
...
public class StaffBotEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -10922836, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("staff_bot_spawn_egg"));
	}
