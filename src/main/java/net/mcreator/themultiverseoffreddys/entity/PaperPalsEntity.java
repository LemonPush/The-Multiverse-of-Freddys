...
import net.mcreator.themultiverseoffreddys.entity.renderer.PaperPalsRenderer;
...
public class PaperPalsEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -6750208, new Item.Properties().group(FNaF2TabItemGroup.tab))
				.setRegistryName("paper_pals_spawn_egg"));
	}
