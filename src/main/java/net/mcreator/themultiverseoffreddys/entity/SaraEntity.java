...
import net.mcreator.themultiverseoffreddys.entity.renderer.SaraRenderer;
...
public class SaraEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -16764007, new Item.Properties().group(PopgoesTabItemGroup.tab))
				.setRegistryName("sara_spawn_egg"));
	}
