...
import net.mcreator.themultiverseoffreddys.entity.renderer.GumdropAngelRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class GumdropAngelEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -16777114, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("gumdrop_angel_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BirthdayGummyItem.block));
		}
