...
import net.mcreator.themultiverseoffreddys.procedures.HenryRightClickedOnEntityProcedure;
import net.mcreator.themultiverseoffreddys.procedures.HenryOnInitialEntitySpawnProcedure;
import net.mcreator.themultiverseoffreddys.item.PartyHatItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedHenryRenderer;
...
public class TamedHenryEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.8f)).build("tamed_henry").setRegistryName("tamed_henry");

	public TamedHenryEntity(UltimateFnafModModElements instance) {
		super(instance, 616);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedHenryRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(PartyHatItem.block), false));
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			HenryOnInitialEntitySpawnProcedure
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			HenryRightClickedOnEntityProcedure.executeProcedure(Stream
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (PartyHatItem.block == stack.getItem())
				return true;
			return false;
		}
	}
