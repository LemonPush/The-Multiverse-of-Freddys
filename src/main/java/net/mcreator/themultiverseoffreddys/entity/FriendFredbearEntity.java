...
import net.mcreator.themultiverseoffreddys.entity.renderer.FriendFredbearRenderer;
...
public class FriendFredbearEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -13159, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("friend_fredbear_spawn_egg"));
	}
