...
import net.mcreator.themultiverseoffreddys.entity.renderer.AntonetteRenderer;
...
public class AntonetteEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4802890, -855310, new Item.Properties().group(JollyTabItemGroup.tab))
				.setRegistryName("antonette_spawn_egg"));
	}
