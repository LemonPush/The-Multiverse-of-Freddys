...
import net.mcreator.themultiverseoffreddys.entity.renderer.BidybabRenderer;
...
public class BidybabEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -2445436, new Item.Properties().group(FNaF5TabItemGroup.tab))
				.setRegistryName("bidybab_spawn_egg"));
	}
