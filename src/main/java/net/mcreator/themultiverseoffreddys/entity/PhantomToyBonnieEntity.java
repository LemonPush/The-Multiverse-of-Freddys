...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomToyBonnieRenderer;
...
public class PhantomToyBonnieEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("phantom_toy_bonnie").setRegistryName("phantom_toy_bonnie");

	public PhantomToyBonnieEntity(UltimateFnafModModElements instance) {
		super(instance, 316);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PhantomToyBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16376299, -16248288, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("phantom_toy_bonnie_spawn_egg"));
	}
