...
import net.mcreator.themultiverseoffreddys.entity.renderer.HardcoreChicaRenderer;
...
public class HardcoreChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -16777216, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("hardcore_chica_spawn_egg"));
	}
