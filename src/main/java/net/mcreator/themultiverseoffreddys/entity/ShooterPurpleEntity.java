...
import net.mcreator.themultiverseoffreddys.entity.renderer.ShooterPurpleRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class ShooterPurpleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13434829, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("shooter_purple_spawn_egg"));
	}
