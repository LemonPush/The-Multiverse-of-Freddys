...
import net.mcreator.themultiverseoffreddys.entity.renderer.CaptainFoxyRenderer;
...
public class CaptainFoxyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777165, -6865860, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("captain_foxy_spawn_egg"));
	}
