...
import net.mcreator.themultiverseoffreddys.procedures.WilliamRightClickProcedure;
import net.mcreator.themultiverseoffreddys.procedures.WilliamOnInitialProcedure;
import net.mcreator.themultiverseoffreddys.item.AgonyItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedWilliamAftonRenderer;
...
public class TamedWilliamAftonEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			WilliamRightClickProcedure.executeProcedure(Stream
