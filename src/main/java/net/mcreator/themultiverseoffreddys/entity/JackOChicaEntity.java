...
import net.mcreator.themultiverseoffreddys.entity.renderer.JackOChicaRenderer;
...
public class JackOChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6737152, -10079488, new Item.Properties().group(FNaF4TabItemGroup.tab))
				.setRegistryName("jack_o_chica_spawn_egg"));
	}
