...
import net.mcreator.themultiverseoffreddys.entity.renderer.EasterBonnieRenderer;
...
public class EasterBonnieEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -2434342, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("easter_bonnie_spawn_egg"));
	}
