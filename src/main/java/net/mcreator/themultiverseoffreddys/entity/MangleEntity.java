...
import net.mcreator.themultiverseoffreddys.entity.renderer.MangleRenderer;
...
public class MangleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -9737365, -1, new Item.Properties().group(FNaF2TabItemGroup.tab)).setRegistryName("mangle_spawn_egg"));
	}
