...
import net.mcreator.themultiverseoffreddys.procedures.TamedGlitchtrapHurtProcedure;
import net.mcreator.themultiverseoffreddys.item.TapeItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.TamedGlitchtrapRenderer;
...
public class TamedGlitchtrapEntity extends UltimateFnafModModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TamedGlitchtrapHurtProcedure.executeProcedure(Stream
