...
import net.mcreator.themultiverseoffreddys.procedures.PhantomBlindnessProcedure;
...
import net.mcreator.themultiverseoffreddys.entity.renderer.PhantomToyFreddyRenderer;
...
public class PhantomToyFreddyEntity extends UltimateFnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.4f)).build("phantom_toy_freddy").setRegistryName("phantom_toy_freddy");

	public PhantomToyFreddyEntity(UltimateFnafModModElements instance) {
		super(instance, 314);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PhantomToyFreddyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16050686, -16579328, new Item.Properties().group(HoaxesTabItemGroup.tab))
				.setRegistryName("phantom_toy_freddy_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(AgonyItem.block));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimate_fnaf_mod:death3"));
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			PhantomBlindnessProcedure.executeProcedure(
