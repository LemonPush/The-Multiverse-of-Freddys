...
import net.mcreator.themultiverseoffreddys.entity.renderer.RockstarChicaRenderer;
...
public class RockstarChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1917161, -6535401, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("rockstar_chica_spawn_egg"));
	}
