...
import net.mcreator.themultiverseoffreddys.entity.renderer.VRToyFreddyRenderer;
...
public class VRToyFreddyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -10092442, new Item.Properties().group(ARTabItemGroup.tab))
				.setRegistryName("vr_toy_freddy_spawn_egg"));
	}
