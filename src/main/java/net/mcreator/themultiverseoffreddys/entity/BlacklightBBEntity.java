...
import net.mcreator.themultiverseoffreddys.entity.renderer.BlacklightBBRenderer;
...
public class BlacklightBBEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750055, -16764007, new Item.Properties().group(F3ItemGroup.tab))
				.setRegistryName("blacklight_bb_spawn_egg"));
	}
