...
import net.mcreator.themultiverseoffreddys.procedures.ChipperRightClickProcedure;
import net.mcreator.themultiverseoffreddys.procedures.ChipperInitialProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.OthersTabItemGroup;
import net.mcreator.themultiverseoffreddys.item.PezDispenserItem;
import net.mcreator.themultiverseoffreddys.entity.renderer.ChipperRenderer;
...
public class ChipperEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -16777063, new Item.Properties().group(OthersTabItemGroup.tab))
				.setRegistryName("chipper_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.fromItems(PezDispenserItem.block), false));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			ChipperRightClickProcedure.executeProcedure(Stream
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (PezDispenserItem.block == stack.getItem())
				return true;
			return false;
		}
	}
