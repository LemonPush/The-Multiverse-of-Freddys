...
import net.mcreator.themultiverseoffreddys.entity.renderer.OutOfStockRenderer;
...
public class OutOfStockEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3342490, -13408768, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("out_of_stock_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PlushtrapChaserBodyBlock.block));
		}
