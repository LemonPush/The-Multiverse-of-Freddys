...
import net.mcreator.themultiverseoffreddys.entity.renderer.TheFaceRenderer;
...
public class TheFaceEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3890044, -11858932, new Item.Properties().group(TreasureTabItemGroup.tab))
				.setRegistryName("the_face_spawn_egg"));
	}
