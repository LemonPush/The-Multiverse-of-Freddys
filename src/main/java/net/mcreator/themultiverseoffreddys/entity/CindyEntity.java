...
import net.mcreator.themultiverseoffreddys.entity.renderer.CindyRenderer;
...
public class CindyEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -6750055, new Item.Properties().group(CandyTabItemGroup.tab))
				.setRegistryName("cindy_spawn_egg"));
	}
