...
import net.mcreator.themultiverseoffreddys.entity.renderer.FreddleRenderer;
...
public class FreddleEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14347519, -11918573, new Item.Properties().group(FNaF4TabItemGroup.tab))
				.setRegistryName("freddle_spawn_egg"));
	}
