...
import net.mcreator.themultiverseoffreddys.entity.renderer.LittleMusicManRenderer;
...
public class LittleMusicManEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -6750055, new Item.Properties().group(FNaF9TabItemGroup.tab))
				.setRegistryName("little_music_man_spawn_egg"));
	}
