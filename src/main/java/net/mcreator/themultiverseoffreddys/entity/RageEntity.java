...
import net.mcreator.themultiverseoffreddys.procedures.RevengeLootProcedure;
import net.mcreator.themultiverseoffreddys.itemgroup.F2ItemGroup;
import net.mcreator.themultiverseoffreddys.entity.renderer.RageRenderer;
...
public class RageEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -39322, -65536, new Item.Properties().group(F2ItemGroup.tab)).setRegistryName("rage_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			RevengeLootProcedure.executeProcedure(Stream
