...
import net.mcreator.themultiverseoffreddys.entity.renderer.PenguinRenderer;
...
public class PenguinEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(CandyTabItemGroup.tab))
