...
import net.mcreator.themultiverseoffreddys.entity.renderer.CyanideRenderer;
...
public class CyanideEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737895, -16751002, new Item.Properties().group(PopgoesTabItemGroup.tab))
				.setRegistryName("cyanide_spawn_egg"));
	}
