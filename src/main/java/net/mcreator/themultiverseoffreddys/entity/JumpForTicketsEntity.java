...
import net.mcreator.themultiverseoffreddys.entity.renderer.JumpForTicketsRenderer;
import net.mcreator.themultiverseoffreddys.UltimateFnafModModElements;

@UltimateFnafModModElements.ModElement.Tag
public class JumpForTicketsEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13074926, -2042357, new Item.Properties().group(FFTabItemGroup.tab))
				.setRegistryName("jump_for_tickets_spawn_egg"));
	}
