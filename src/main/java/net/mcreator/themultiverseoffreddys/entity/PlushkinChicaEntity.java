...
import net.mcreator.themultiverseoffreddys.entity.renderer.PlushkinChicaRenderer;
...
public class PlushkinChicaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355648, -10066432, new Item.Properties().group(FNaF8TabItemGroup.tab))
				.setRegistryName("plushkin_chica_spawn_egg"));
	}
