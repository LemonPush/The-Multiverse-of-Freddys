...
import net.mcreator.themultiverseoffreddys.entity.renderer.HappyFrogRenderer;
...
public class HappyFrogEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13395712, -13408768, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("happy_frog_spawn_egg"));
	}
