...
import net.mcreator.themultiverseoffreddys.entity.renderer.BucketRenderer;
...
public class BucketEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -10079488, new Item.Properties().group(FNaF6TabItemGroup.tab))
				.setRegistryName("bucket_spawn_egg"));
	}
