...
import net.mcreator.themultiverseoffreddys.entity.renderer.BVShadowRenderer;
...
public class BVShadowEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -16777216, new Item.Properties().group(F1ItemGroup.tab))
				.setRegistryName("bv_shadow_spawn_egg"));
	}
