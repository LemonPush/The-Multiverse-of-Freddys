...
import net.mcreator.themultiverseoffreddys.entity.renderer.BubbaRenderer;
...
public class BubbaEntity extends UltimateFnafModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -10079488, -6724096, new Item.Properties().group(F2ItemGroup.tab)).setRegistryName("bubba_spawn_egg"));
	}
