...
public class TopWallFNaF2Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:top_wall_f_na_f_2")
	public static final Block block = null;

	public TopWallFNaF2Block(UltimateFnafModModElements instance) {
		super(instance, 148);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("top_wall_f_na_f_2");
		}
