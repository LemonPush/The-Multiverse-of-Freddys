...
public class DarkGrayStairBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:dark_gray_stair")
	public static final Block block = null;

	public DarkGrayStairBlock(UltimateFnafModModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_gray_stair");
		}
