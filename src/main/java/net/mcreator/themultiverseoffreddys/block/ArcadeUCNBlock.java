...
public class ArcadeUCNBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:arcade_ucn")
	public static final Block block = null;

	public ArcadeUCNBlock(UltimateFnafModModElements instance) {
		super(instance, 52);
	}
