...
public class TVsBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:t_vs")
	public static final Block block = null;

	public TVsBlock(UltimateFnafModModElements instance) {
		super(instance, 125);
	}
