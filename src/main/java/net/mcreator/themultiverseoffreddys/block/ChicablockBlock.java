...
import net.mcreator.themultiverseoffreddys.procedures.ChicablockOnBlockRightClickedProcedure;
...
public class ChicablockBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:chicablock")
	public static final Block block = null;

	public ChicablockBlock(UltimateFnafModModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			ChicablockOnBlockRightClickedProcedure.executeProcedure(Stream
