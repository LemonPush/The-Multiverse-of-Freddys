...
public class BedroomBottomBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:bedroom_bottom")
	public static final Block block = null;

	public BedroomBottomBlock(UltimateFnafModModElements instance) {
		super(instance, 151);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bedroom_bottom");
		}
