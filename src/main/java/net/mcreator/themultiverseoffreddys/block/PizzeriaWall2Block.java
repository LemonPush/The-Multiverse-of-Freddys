...
public class PizzeriaWall2Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:pizzeria_wall_2")
	public static final Block block = null;

	public PizzeriaWall2Block(UltimateFnafModModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pizzeria_wall_2");
		}
