...
import net.mcreator.themultiverseoffreddys.procedures.TVOnBlockRightClickedProcedure;
...
public class TVBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:tv")
	public static final Block block = null;

	public TVBlock(UltimateFnafModModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			TVOnBlockRightClickedProcedure.executeProcedure(Stream
