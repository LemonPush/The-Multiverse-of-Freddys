...
public class Floor6Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:floor_6")
	public static final Block block = null;

	public Floor6Block(UltimateFnafModModElements instance) {
		super(instance, 138);
	}
