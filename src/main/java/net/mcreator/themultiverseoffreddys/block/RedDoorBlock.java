...
public class RedDoorBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:red_door")
	public static final Block block = null;

	public RedDoorBlock(UltimateFnafModModElements instance) {
		super(instance, 131);
	}
