...
import net.mcreator.themultiverseoffreddys.procedures.CutoutOnBlockRightClickedProcedure;
...
public class CutoutBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:cutout")
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Hide-and-Seek"));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			CutoutOnBlockRightClickedProcedure.executeProcedure(Stream
