...
public class BoxOfAnimatronicsBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:box_of_animatronics")
	public static final Block block = null;

	public BoxOfAnimatronicsBlock(UltimateFnafModModElements instance) {
		super(instance, 113);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("box_of_animatronics");
		}
