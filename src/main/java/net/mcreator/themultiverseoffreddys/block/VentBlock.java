...
public class VentBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:vent")
	public static final Block block = null;

	public VentBlock(UltimateFnafModModElements instance) {
		super(instance, 134);
	}
