...
import net.mcreator.themultiverseoffreddys.procedures.BlackbirdBodyOnBlockRightClickedProcedure;
...
public class BlackbirdBodyBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:blackbird_body")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blackbird_body");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Blackbird"));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			BlackbirdBodyOnBlockRightClickedProcedure.executeProcedure(Stream
