...
public class FreddyStandBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:freddy_stand")
	public static final Block block = null;

	public FreddyStandBlock(UltimateFnafModModElements instance) {
		super(instance, 109);
	}
