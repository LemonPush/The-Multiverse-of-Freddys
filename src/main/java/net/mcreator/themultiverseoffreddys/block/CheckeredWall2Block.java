...
public class CheckeredWall2Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:checkered_wall_2")
	public static final Block block = null;

	public CheckeredWall2Block(UltimateFnafModModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("checkered_wall_2");
		}
