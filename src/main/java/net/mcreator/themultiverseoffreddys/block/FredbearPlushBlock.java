...
public class FredbearPlushBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:fredbear_plush")
	public static final Block block = null;

	public FredbearPlushBlock(UltimateFnafModModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("fredbear_plush");
		}
