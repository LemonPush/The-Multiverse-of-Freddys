...
import net.mcreator.themultiverseoffreddys.procedures.DeadKidOnBlockRightClickedProcedure;
...
public class DeadKidBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:dead_kid")
	public static final Block block = null;

	public DeadKidBlock(UltimateFnafModModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			DeadKidOnBlockRightClickedProcedure.executeProcedure(Stream
