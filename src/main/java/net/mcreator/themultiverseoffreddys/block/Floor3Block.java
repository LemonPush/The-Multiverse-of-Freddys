...
public class Floor3Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:floor_3")
	public static final Block block = null;

	public Floor3Block(UltimateFnafModModElements instance) {
		super(instance, 140);
	}
