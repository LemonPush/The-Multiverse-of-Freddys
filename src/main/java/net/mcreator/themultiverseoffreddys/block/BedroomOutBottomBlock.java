...
public class BedroomOutBottomBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:bedroom_out_bottom")
	public static final Block block = null;

	public BedroomOutBottomBlock(UltimateFnafModModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bedroom_out_bottom");
		}
