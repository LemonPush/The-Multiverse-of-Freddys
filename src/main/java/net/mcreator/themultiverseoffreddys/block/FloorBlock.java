...
public class FloorBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:floor")
	public static final Block block = null;

	public FloorBlock(UltimateFnafModModElements instance) {
		super(instance, 136);
	}
