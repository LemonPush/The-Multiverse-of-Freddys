...
public class EggbabyBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:eggbaby")
	public static final Block block = null;

	public EggbabyBlock(UltimateFnafModModElements instance) {
		super(instance, 115);
	}
