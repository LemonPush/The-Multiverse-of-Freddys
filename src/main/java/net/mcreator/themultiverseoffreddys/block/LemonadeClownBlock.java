...
public class LemonadeClownBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:lemonade_clown")
	public static final Block block = null;

	public LemonadeClownBlock(UltimateFnafModModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("lemonade_clown");
		}
