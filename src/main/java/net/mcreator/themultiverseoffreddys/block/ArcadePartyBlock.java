...
public class ArcadePartyBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:arcade_party")
	public static final Block block = null;

	public ArcadePartyBlock(UltimateFnafModModElements instance) {
		super(instance, 53);
	}
