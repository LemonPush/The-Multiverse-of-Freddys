...
public class Floor2Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:floor_2")
	public static final Block block = null;

	public Floor2Block(UltimateFnafModModElements instance) {
		super(instance, 137);
	}
