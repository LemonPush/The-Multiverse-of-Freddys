...
public class Wall3Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:wall_3")
	public static final Block block = null;

	public Wall3Block(UltimateFnafModModElements instance) {
		super(instance, 147);
	}
