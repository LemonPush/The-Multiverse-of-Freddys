...
public class SpringBonniePlushBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:spring_bonnie_plush")
	public static final Block block = null;

	public SpringBonniePlushBlock(UltimateFnafModModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("spring_bonnie_plush");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Property of Fredbear's Family Diner"));
		}
