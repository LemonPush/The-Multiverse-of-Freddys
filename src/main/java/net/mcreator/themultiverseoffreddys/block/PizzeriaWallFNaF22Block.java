...
public class PizzeriaWallFNaF22Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:pizzeria_wall_f_na_f_22")
	public static final Block block = null;

	public PizzeriaWallFNaF22Block(UltimateFnafModModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pizzeria_wall_f_na_f_22");
		}
