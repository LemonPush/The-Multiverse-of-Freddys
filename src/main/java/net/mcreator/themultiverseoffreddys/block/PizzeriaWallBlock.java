...
public class PizzeriaWallBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:pizzeria_wall")
	public static final Block block = null;

	public PizzeriaWallBlock(UltimateFnafModModElements instance) {
		super(instance, 143);
	}
