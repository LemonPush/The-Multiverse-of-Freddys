...
public class BedroomOutTopBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:bedroom_out_top")
	public static final Block block = null;

	public BedroomOutTopBlock(UltimateFnafModModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bedroom_out_top");
		}
