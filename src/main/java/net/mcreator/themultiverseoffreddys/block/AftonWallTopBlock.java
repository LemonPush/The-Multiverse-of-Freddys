...
public class AftonWallTopBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:afton_wall_top")
	public static final Block block = null;

	public AftonWallTopBlock(UltimateFnafModModElements instance) {
		super(instance, 154);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("afton_wall_top");
		}
