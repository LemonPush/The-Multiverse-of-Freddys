...
public class FruitpunchClownBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:fruitpunch_clown")
	public static final Block block = null;

	public FruitpunchClownBlock(UltimateFnafModModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("fruitpunch_clown");
		}
