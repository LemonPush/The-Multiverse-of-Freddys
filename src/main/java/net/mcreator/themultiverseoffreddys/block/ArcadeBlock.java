...
public class ArcadeBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:arcade")
	public static final Block block = null;

	public ArcadeBlock(UltimateFnafModModElements instance) {
		super(instance, 349);
	}
