...
public class EmployeeDoorBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:employee_door")
	public static final Block block = null;

	public EmployeeDoorBlock(UltimateFnafModModElements instance) {
		super(instance, 132);
	}
