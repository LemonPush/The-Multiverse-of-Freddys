...
public class Floor5Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:floor_5")
	public static final Block block = null;

	public Floor5Block(UltimateFnafModModElements instance) {
		super(instance, 139);
	}
