...
public class GlitchBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:glitch")
	public static final Block block = null;

	public GlitchBlock(UltimateFnafModModElements instance) {
		super(instance, 259);
	}
