...
public class ComputerBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:computer")
	public static final Block block = null;

	public ComputerBlock(UltimateFnafModModElements instance) {
		super(instance, 123);
	}
