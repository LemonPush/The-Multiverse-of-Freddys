...
public class PizzeriawalltopBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:pizzeriawalltop")
	public static final Block block = null;

	public PizzeriawalltopBlock(UltimateFnafModModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pizzeriawalltop");
		}
