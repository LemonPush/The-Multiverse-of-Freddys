...
public class FanBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:fan")
	public static final Block block = null;

	public FanBlock(UltimateFnafModModElements instance) {
		super(instance, 122);
	}
