...
import net.mcreator.themultiverseoffreddys.procedures.FlipsideSpawnerBlockAddedProcedure;
...
public class FlipsideSpawnerBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:flipside_spawner")
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("flipside_spawner");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			FlipsideSpawnerBlockAddedProcedure.executeProcedure(Stream
