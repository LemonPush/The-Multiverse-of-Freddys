...
public class BedroomDoorBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:bedroom_door")
	public static final Block block = null;

	public BedroomDoorBlock(UltimateFnafModModElements instance) {
		super(instance, 133);
	}
