...
public class ExoticButtersBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:exotic_butters")
	public static final Block block = null;

	public ExoticButtersBlock(UltimateFnafModModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("exotic_butters");
		}
