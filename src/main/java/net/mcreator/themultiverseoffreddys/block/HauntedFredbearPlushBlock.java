...
public class HauntedFredbearPlushBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:haunted_fredbear_plush")
	public static final Block block = null;

	public HauntedFredbearPlushBlock(UltimateFnafModModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("haunted_fredbear_plush");
		}
