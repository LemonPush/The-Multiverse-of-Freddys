...
public class DarkGraySlabBlock extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:dark_gray_slab")
	public static final Block block = null;

	public DarkGraySlabBlock(UltimateFnafModModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_gray_slab");
		}
