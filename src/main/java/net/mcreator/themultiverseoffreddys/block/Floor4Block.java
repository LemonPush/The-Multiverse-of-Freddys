...
public class Floor4Block extends UltimateFnafModModElements.ModElement {
	@ObjectHolder("ultimate_fnaf_mod:floor_4")
	public static final Block block = null;

	public Floor4Block(UltimateFnafModModElements instance) {
		super(instance, 141);
	}
