...
public class MemoriesDimension extends UltimateFnafModModElements.ModElement {
	public MemoriesDimension(UltimateFnafModModElements instance) {
		super(instance, 913);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("ultimate_fnaf_mod:memory")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("ultimate_fnaf_mod:memories"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
