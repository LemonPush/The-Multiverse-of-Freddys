...
import net.mcreator.themultiverseoffreddys.block.GlitchBlock;
...
public class GlitchyPlaneBiome extends UltimateFnafModModElements.ModElement {
	public static Biome biome;

	public GlitchyPlaneBiome(UltimateFnafModModElements instance) {
		super(instance, 1117);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-12384194).setWaterColor(-16777216).setWaterFogColor(329011)
						.withSkyColor(-12384194).withFoliageColor(10387789).withGrassColor(9470285).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(GlitchBlock.block.getDefaultState(),
								GlitchBlock.block.getDefaultState(), GlitchBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("ultimate_fnaf_mod:glitchy_plane"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("glitchy_plane_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("glitchy_plane_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("glitchy_plane_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
