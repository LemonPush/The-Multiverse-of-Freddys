...
public class NegativeBiomeBiome extends UltimateFnafModModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-256).setWaterColor(-1).setWaterFogColor(-256).withSkyColor(-256)
						.withFoliageColor(-16776961).withGrassColor(-16776961).build();
				...
				event.getRegistry().register(biome.setRegistryName("ultimate_fnaf_mod:negative_biome"));
			}
		}
	}
